...
可以在**按住 Ctrl 键的同时单击**或者使用以下屏幕截图所示的上下文菜单跳转到定义：

![Visual Studio Code 资源管理器工具扩展 - 转到定义](./media/use-vs-code-to-create-template/resource-manager-tools-extension-context-menu.png)
...
- 若要使用 Visual Studio Code 完成某篇快速入门，请参阅[快速入门：使用 Visual Studio Code 创建 Azure 资源管理器模板](quickstart-create-templates-use-visual-studio-code.md)
