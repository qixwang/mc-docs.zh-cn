...
ms.topic: tutorial
ms.author: v-yeche
ms.openlocfilehash: 82d5bee643bc7ba9112ee137ec2218bb09353b14
ms.sourcegitcommit: 81241aa44adbcac0764e2b5eb865b96ae56da6b7
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/09/2020
ms.locfileid: "83002054"
---
...
1. 输入以下值：
    ...
    * **订阅 ID**：输入订阅 ID。
    * **订阅名称**：输入订阅名称。
    * **服务主体 ID**：输入上一 `az ad sp create-for-rbac` 步骤中的 appId  输出。
    * **凭据**：选择“服务主体密钥”  。
    * **服务主体密钥**：输入上一 `az ad sp create-for-rbac` 步骤中的 password  输出。 
    * **租户 ID**：输入上一 `az ad sp create-for-rbac` 步骤中的 tenant  输出。 
