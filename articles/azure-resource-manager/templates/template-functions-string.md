...
ms.date: 04/30/2020
ms.author: v-yeche
ms.openlocfilehash: 77c4709c3beae995b2d645ac10f337f85c119b7d
ms.sourcegitcommit: b469d275694fb86bbe37a21227e24019043b9e88
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/30/2020
ms.locfileid: "82596138"
---
# <a name="string-functions-for-arm-templates"></a>ARM 模板的字符串函数

资源管理器提供了以下用于处理 Azure 资源管理器 (ARM) 模板中字符串的函数：
...
newGuid 函数会使用 .NET Framework 中的 [Guid 结构](https://docs.microsoft.com/dotnet/api/system.guid)生成全局唯一标识符。

<!--CORRECT ON https://docs.microsoft.com/dotnet/api/system.guid-->
