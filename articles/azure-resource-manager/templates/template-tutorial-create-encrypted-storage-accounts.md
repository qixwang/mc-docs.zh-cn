...
![资源管理器模板参考部署加密的存储帐户](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-tutorial-deploy-encrypted-storage-account.png)
...
1. 在 VS Code 中将模板折叠到根级别。 你使用最简单的结构，其中包含以下元素：
    ...
    ![资源管理器模板的最简单结构](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-simplest-structure.png)
...
2. 展开“resources”  。 已定义 `Microsoft.Storage/storageAccounts` 资源。 此模板创建非加密存储帐户。
    ...
    ![资源管理器模板存储帐户定义](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resource.png)
...
![资源管理器模板加密的存储帐户资源](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resources.png)
...
![Azure 资源管理器加密的存储帐户](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-account.png)
