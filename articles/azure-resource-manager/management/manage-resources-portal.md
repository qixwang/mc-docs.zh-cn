...
ms.date: 01/06/2020
ms.author: v-yeche
ms.openlocfilehash: 61b4a1f68ae117aadb9ddfd67a9e7eb403398be3
ms.sourcegitcommit: 3c98f52b6ccca469e598d327cd537caab2fde83f
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/13/2020
ms.locfileid: "79293152"
---
# <a name="manage-azure-resources-by-using-the-azure-portal"></a>使用 Azure 门户管理 Azure 资源

了解如何将 [Azure 门户](https://portal.azure.cn)与 [Azure 资源管理器](overview.md)配合使用来管理 Azure 资源。 若要管理资源组，请参阅[使用 Azure 门户管理 Azure 资源组](manage-resource-groups-portal.md)。
