...
ms.openlocfilehash: 5d1e8eb6707acffa654bc0cd802d6ad87784b46a
ms.sourcegitcommit: f8d6fa25642171d406a1a6ad6e72159810187933
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/28/2020
ms.locfileid: "82198467"
---
...
可以通过增加或减少数据仓库单位来缩放 SQL 池计算资源。 [创建和连接 - 门户](create-data-warehouse-portal.md)创建了 **mySampleDataWarehouse** 并使用 400 个 DWU 对其进行了初始化。 以下步骤调整为 DWU **mySampleDataWarehouse**。
