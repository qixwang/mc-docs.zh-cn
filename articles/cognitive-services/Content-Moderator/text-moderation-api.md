...
内容审查器提供[字词列表 API](https://dev.cognitive.azure.cn/docs/services/57cf755e3f9b070c105bd2c2/operations/57cf755e3f9b070868a1f67f) 和相应的操作用于管理自定义字词列表。 请从[字词列表 API 控制台](try-terms-list-api.md)开始，使用 REST API 代码示例。 如果你熟悉 Visual Studio 和 C#，另请参阅[字词列表 .NET 快速入门](term-lists-quickstart-dotnet.md)。
