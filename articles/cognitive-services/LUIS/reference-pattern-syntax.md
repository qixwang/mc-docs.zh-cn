...
要避免模式出现此异常，需使用`the man from la mancha`显式列表的创作 API[ 添加 ](https://{region}.dev.cognitive.azure.cn/docs/services/5890b47c39e2bb17b84a55ff/operations/5ade550bd5b81c209ce2e5a8) 作为 {subject} 实体的显式列表匹配。
