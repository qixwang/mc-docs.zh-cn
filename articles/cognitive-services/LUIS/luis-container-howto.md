...
ms.date: 08/04/2020
ms.author: v-johya
ms.openlocfilehash: 18ead1ead825bc2cea930eb4ebc14e7f94c7b2bf
ms.sourcegitcommit: caa18677adb51b5321ad32ae62afcf92ac00b40b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/08/2020
ms.locfileid: "88023427"
---
# <a name="install-and-run-luis-docker-containers"></a>安装并运行 LUIS docker 容器

语言理解 (LUIS) 容器加载已训练或已发布的语言理解模型。 作为 [LUIS 应用](https://luis.azure.cn)，docker 容器提供从容器的 API 终结点执行预测查询的访问权限。 可以从容器中收集查询日志并将这些日志上传回语言理解应用以提高应用的预测准确性。
...
* [已发布的包 API](https://dev.cognitive.azure.cn/docs/services/5890b47c39e2bb17b84a55ff/operations/apps-packagepublishedapplicationasgzip)
* [未发布、仅经过训练的包 API](https://dev.cognitive.azure.cn/docs/services/5890b47c39e2bb17b84a55ff/operations/apps-packagetrainedapplicationasgzip)
...
无法更改正在容器中运行的应用。 若要更改容器中的应用，必须使用 [LUIS](https://luis.azure.cn) 门户或使用 LUIS [创作 API](https://dev.cognitive.azure.cn/docs/services/5890b47c39e2bb17b84a55ff/operations/5890b47c39e2bb052c5b9c2f) 更改 LUIS 服务中的应用。 然后进行训练和/或发布，下载新包并再次运行该容器。
...
|打包要求|详细信息|
|--|--|
|Azure __ 认知服务资源实例|支持的区域包括<br><br>中国北部 (`chinanorth`)<br>中国东部 2 (`chinaeast2`)|
...
| **{AZURE_REGION}** | 相应的 Azure 区域：<br/><br/>`chinaeast2` - 中国东部 2 |
...
|包类型|HTTP 谓词|路由|查询参数|
|--|--|--|--|
|已发布|[GET](https://dev.cognitive.azure.cn/docs/services/5819c76f40a6350ce09de1ac/operations/5819c77140a63516d81aee78)、[POST](https://dev.cognitive.azure.cn/docs/services/5819c76f40a6350ce09de1ac/operations/5819c77140a63516d81aee79)|`/luis/v2.0/apps/{appId}?`|`q={q}`<br>`&staging`<br>[`&timezoneOffset`]<br>[`&verbose`]<br>[`&log`]<br>|
...
上传日志后，在 LUIS 门户中[查看终结点](/cognitive-services/luis/luis-concept-review-endpoint-utterances)话语。
...
<!-- Links - external -->
[download-published-package]: https://dev.cognitive.azure.cn/docs/services/5890b47c39e2bb17b84a55ff/operations/apps-packagepublishedapplicationasgzip
[download-versioned-package]: https://dev.cognitive.azure.cn/docs/services/5890b47c39e2bb17b84a55ff/operations/apps-packagetrainedapplicationasgzip
