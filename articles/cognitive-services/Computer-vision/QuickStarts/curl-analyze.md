...
ms.author: v-johya
ms.custom: seodec18
ms.openlocfilehash: 83b0c171b05f41419c1f57d4e7f8aabf79551410
ms.sourcegitcommit: caa18677adb51b5321ad32ae62afcf92ac00b40b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 08/08/2020
ms.locfileid: "88023328"
---
...
1. 必要时在命令中进行如下更改：
    ...
    1. 将请求 URL 的第一部分 (`chinanorth`) 替换为你自己的终结点 URL 中的文本。
...
```bash
curl -H "Ocp-Apim-Subscription-Key: <subscriptionKey>" -H "Content-Type: application/json" "https://chinanorth.api.cognitive.azure.cn/vision/v3.0/analyze?visualFeatures=Categories,Description&details=Landmarks" -d "{\"url\":\"http://upload.wikimedia.org/wikipedia/commons/3/3c/Shaki_waterfall.jpg\"}"
```
