...
description: 语音服务将语音转文本统合到单个 Azure 订阅。 使用语音 SDK、语音设备 SDK 或 REST API 在应用程序、工具和设备中添加语音。
...
ms.date: 01/13/2020
ms.author: v-tawe
ms.openlocfilehash: 45bbc2e2cc8cee47583b88ca18d626b9ccab2e10
ms.sourcegitcommit: 6fb55092f9e99cf7b27324c61f5fab7f579c37dc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/03/2020
ms.locfileid: "75631074"
---
# <a name="what-is-the-speech-service"></a>什么是语音服务？

语音服务将语音转文本统合到单个 Azure 订阅。 使用[语音 SDK](speech-sdk-reference.md)、[语音设备 SDK](speech-devices-sdk-android-quickstart.md) 或 [REST API](rest-apis.md) 可以轻松在应用程序、工具和设备中启用语音。
