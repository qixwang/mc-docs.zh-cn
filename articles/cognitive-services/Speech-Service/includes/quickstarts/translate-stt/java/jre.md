...
ms.date: 03/16/2020
ms.author: v-tawe
ms.openlocfilehash: 9605175886e7049f7746bd7ae91ba130515efd31
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "80151563"
---
...
1. 将 `Main.java` 中的所有代码替换为以下代码片段：
   ...
   public class Main {
       ...
       public static void translationWithMicrophoneAsync() throws InterruptedException, ExecutionException, IOException
       {
           ...
           int exitCode = 1;
           SpeechTranslationConfig config = SpeechTranslationConfig.fromHost(new URI("wss://YourServiceRegion.stt.speech.azure.cn/"),
           assert(config != null);
