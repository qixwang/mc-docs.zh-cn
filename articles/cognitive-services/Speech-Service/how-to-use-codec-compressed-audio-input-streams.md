...
ms.openlocfilehash: 67379cd8d1c14bd7ecaab0e25b49001ee27cd33d
ms.sourcegitcommit: b2f2bb08ab1b5ccb3c596d84b3b6ddca5bba3903
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/24/2020
ms.locfileid: "80151701"
---
...
> [!IMPORTANT]
> 目前，Linux（Ubuntu 16.04、Ubuntu 18.04、Debian 9、RHEL 8、CentOS 8）上的 C#、C++ 和 Java 支持流式传输压缩输入音频。 Android 中的 Java 和 iOS 平台中的 Objective-C 也支持该功能。
> 需要语音 SDK 版本 1.7.0 或更高版本（对于 RHEL 8、CentOS 8，需要语音 SDK 版本 1.10.0 或更高版本）。
