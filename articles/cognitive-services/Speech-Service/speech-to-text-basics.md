...
ms.openlocfilehash: 1c33683a6221b6e1ad3b8216509671b54cc8b16d
ms.sourcegitcommit: d24e12d49708bbe78db450466eb4fccbc2eb5f99
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/01/2020
ms.locfileid: "85613391"
---
# <a name="learn-the-basics-of-speech-recognition"></a>了解语音识别的基本知识

语音服务的核心功能之一是能够识别并转录人类语音（通常称为语音转文本）。 本文介绍如何在应用和产品中使用语音 SDK 来执行高质量的语音识别。

> [!TIP]
> 如果你没有机会完成我们的快速入门之一，我们建议你进行尝试，自行试用语音识别。
> * [识别来自麦克风的语音](quickstarts/speech-to-text-from-microphone.md)
