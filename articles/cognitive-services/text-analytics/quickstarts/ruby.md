...
本文展示了如何将[文本分析 API](#Detect)[与 Ruby 配合使用来](#SentimentAnalysis)检测语言[、](#KeyPhraseExtraction)分析情绪[、](#Entities)提取关键短语 [以及](https://www.azure.cn/zh-cn/home/features/cognitive-services/text-analytics/)识别链接的实体 。
