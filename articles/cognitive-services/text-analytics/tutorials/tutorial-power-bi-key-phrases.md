...
> [!NOTE]
> 以下示例假定文本分析 API 终结点以 `https://chinaeast2.api.cognitive.azure.cn` 开头。 可以通过文本分析在 2 个不同的区域创建订阅。 如果注册了另一区域的服务，请确保使用所选区域的终结点。 你可以通过登录到 [Azure 门户](https://portal.azure.cn/)、选择文本分析订阅并选择“概述”页面来找到此终结点。
