...
> [!NOTE]
> 只能将服务标记用于“高级”命名空间。 如果使用“标准”命名空间，请使用运行以下命令时看到的 IP 地址：`nslookup <host name for the namespace>`。 例如：`nslookup contosons.servicebus.chinacloudapi.cn`。 
...
<!--Not Available on  [How to configure private endpoints for a Service Bus namespace](private-link-service.md)-->
