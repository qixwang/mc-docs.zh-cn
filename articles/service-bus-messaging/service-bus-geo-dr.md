...
ms.date: 09/23/2019
ms.author: v-lingwu
ms.openlocfilehash: 9b10467a6661bc46eedcc7de2243e995ed60ede2
ms.sourcegitcommit: a04b0b1009b0c62f2deb7c7acee75a1304d98f87
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/22/2020
ms.locfileid: "83796823"
---
# <a name="azure-service-bus-geo-disaster-recovery"></a>Azure 服务总线异地灾难恢复

当整个 Azure 区域或数据中心（如果未使用[可用性区域](https://en.azure.cn/home/features/products-by-region)）遭遇停机时，在不同区域或数据中心中继续进行数据处理就显得至关重要。 因此，“异地灾难恢复”对于任何企业而言都是非常重要的功能。 Azure 服务总线支持命名空间级别的异地灾难恢复。
...
3. 在主要命名空间与次要命名空间之间创建配对以获取“别名”。
    ...
    >
    > 如果你使用门户来设置灾难恢复配置，则由你在门户中提供此注意事项。
