...
> [!NOTE]
> 如果没有另外指定，则中转消息的默认 [TimeToLive](https://docs.azure.cn/dotnet/api/microsoft.azure.servicebus.message.timetolive#Microsoft_Azure_ServiceBus_Message_TimeToLive) 值为 [TimeSpan.Max](https://docs.microsoft.com/dotnet/api/system.timespan.maxvalue)。
>
...
必须通过 Azure 资源管理器操作或 .NET Framework 客户端 [NamespaceManager](https://docs.microsoft.com/dotnet/api/microsoft.servicebus.namespacemanager) API 设置此 autoDeleteOnIdle 属性。 不能在门户中设置此属性。
