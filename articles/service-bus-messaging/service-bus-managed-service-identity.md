...
ms.date: 2/6/2020
ms.author: aschhab
ms.openlocfilehash: c57053082905e08b1079bc15f40a7141a049428e
ms.sourcegitcommit: 1fbdefdace8a1d3412900c6c3f89678d8a9b29bc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/07/2020
ms.locfileid: "82886919"
---
...
- **队列**、**主题**或**订阅**：角色分配适用于特定的服务总线实体。 目前，Azure 门户不支持在订阅级别为服务总线 RBAC 角色分配用户/组/托管标识。 下面是使用 Azure CLI 命令 [az-role-assignment-create](https://docs.azure.cn/cli/role/assignment?view=azure-cli-latest#az-role-assignment-create) 为服务总线 RBAC 角色分配标识的示例： 
