---
title: Azure Data Box Disk 排查数据复制问题 | Microsoft Docs
description: 介绍如何使用日志排查在 Azure Data Box Disk 的数据复制过程中出现的问题。
services: databox
author: WenJason
ms.service: databox
ms.subservice: disk
...
ms.date: 07/27/2020
ms.author: v-jay
ms.openlocfilehash: a2a3d6edae36351aaed6853a48a258c792ed4d1a
ms.sourcegitcommit: c3f15613c875bb52d5a105445efd0f36b9f24c9c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/20/2020
ms.locfileid: "86473464"
---
...
如果不是这种情况，请从具有 Data Box Disk 解锁工具的文件夹中复制日志，然后[联系 Azure 支持部门](https://portal.azure.cn/#blade/Microsoft_Azure_Support/HelpAndSupportBlade/overview)。
...
- 了解如何[排查验证工具问题](data-box-disk-troubleshoot.md)。
