...
:::image type="content" source="media/developer-best-practices-resource-management/vs-code-kubernetes-extension.png" alt-text="适用于 Kubernetes 的 VS Code 扩展中有关缺少内存限制的警告":::
