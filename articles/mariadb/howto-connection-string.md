...
在 [Azure 门户](https://portal.azure.cn)中，转到 Azure Database for MariaDB 服务器，再单击“连接字符串”  ，以获取实例的字符串列表：![Azure 门户中的“连接字符串”窗格](./media/howto-connection-strings/connection-strings-on-portal.png)
