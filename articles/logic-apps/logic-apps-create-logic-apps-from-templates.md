...
如果没有 Azure 订阅，可以在开始前[注册一个 Azure 帐户](https://www.azure.cn/pricing/1rmb-trial/)。 有关构建逻辑应用的详细信息，请参阅[创建逻辑应用](../logic-apps/quickstart-create-first-logic-app-workflow.md)。
...
3. 使用此图片下面表格中的设置创建逻辑应用：
   ...
   | **位置** |  your-Azure-datacenter-region | 选择用于部署逻辑应用的数据中心区域，例如“中国东部”。 | 
   |||| 
...
1. 在 [Azure 门户](https://portal.azure.cn "Azure 门户")的逻辑应用设计器中查找逻辑应用并将其打开。
