...
ms.author: v-yeche
ms.openlocfilehash: 184bbc0c24807dc4779cdb0cbc104227536876b9
ms.sourcegitcommit: 31da682a32dbb41c2da3afb80d39c69b9f9c1bc6
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/16/2020
ms.locfileid: "86414721"
---
...
<!--CORRECT ON https://schema.management.azure.com/providers-->
...
还可以获取在运行时之前不存在的值。 若要表示这些值，可以使用运行时计算的表达式。 表达式是可以包含一个或多个[函数](#functions)、[运算符](#operators)、[变量](/logic-apps/logic-apps-create-variables-store-values)、显式值或常量的序列。 在工作流定义中，可以在 JSON 字符串值中的任何位置使用表达式，只需为表达式加上 \@ 符号前缀即可。 计算表示 JSON 值的表达式时，会通过删除 \@ 字符来提取表达式主体，并且始终生成另一个 JSON 值。
