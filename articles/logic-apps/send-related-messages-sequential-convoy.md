...
<!--Not Avaialble on [Sequential convoy pattern - Azure Architecture Cloud Design Patterns](https://docs.microsoft.com/azure/architecture/patterns/sequential-convoy)-->
...
<!--Not Available on [**Scope** action](../logic-apps/logic-apps-control-flow-run-steps-group-scopes.md)-->
...
<!-- Update_Description: new article about send related messages sequential convoy -->
<!--NEW.date: 07/20/2020-->