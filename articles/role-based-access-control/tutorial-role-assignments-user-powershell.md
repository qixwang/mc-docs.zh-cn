...
1. 在 Azure powershell 中创建一个符合密码复杂性要求的密码。
...
若要为用户授予访问权限，请使用 [New-AzRoleAssignment](https://docs.microsoft.com/powershell/module/az.resources/new-azroleassignment) 命令分配一个角色。 必须指定安全主体、角色定义和范围。
