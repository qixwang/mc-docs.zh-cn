...
可以通过[基于角色的访问控制 (RBAC)](overview.md) 管理对 Azure 资源的访问权限。 在本教程中，将创建资源组并授予用户在资源组中创建和管理虚拟机的访问权限。 本教程重点介绍部署资源管理器模板以授予访问权限的过程。 有关开发资源管理器模板的详细信息，请参阅[资源管理器文档](/azure-resource-manager/)和[模板参考](https://docs.microsoft.com/azure/templates/microsoft.authorization/allversions)。
