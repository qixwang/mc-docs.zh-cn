...
ms.author: v-junlch
ms.date: 06/18/2020
ms.openlocfilehash: 297023a40a8ab29493f19fff09f0bba25a0eeded
ms.sourcegitcommit: 1c01c98a2a42a7555d756569101a85e3245732fd
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/19/2020
ms.locfileid: "85097211"
---
# <a name="azure-resource-providers-operations"></a>Azure 资源提供程序操作

本部分列出了在内置角色中使用的 Azure 资源提供程序的操作。 可以在自己的 [Azure 自定义角色](custom-roles.md)中使用这些操作，以针对 Azure 中的资源提供精细的访问控制。 资源提供程序操作一直在不断发展。 若要获取最新操作，请使用 [Get-AzProviderOperation](https://docs.microsoft.com/powershell/module/az.resources/get-azprovideroperation) 或 [az provider operation list](/cli/provider/operation#az-provider-operation-list)。
...
> | Microsoft.Network/applicationGateways/privateLinkResources/resolvePrivateLinkServiceId/action | 获取应用程序网关专用链接资源的专用链接标识符 |
...
> | microsoft.storagesync/storageSyncServices/registeredServers/providers/Microsoft.Insights/metricDefinitions/read | 获取已注册服务器的可用指标 |
...
> | microsoft.storagesync/storageSyncServices/syncGroups/providers/Microsoft.Insights/metricDefinitions/read | 获取同步组的可用指标 |
...
> | microsoft.storagesync/storageSyncServices/syncGroups/serverEndpoints/providers/Microsoft.Insights/metricDefinitions/read | 获取服务器终结点的可用指标 |
...
> | 操作 | 说明 |
> | --- | --- |
> | Microsoft.CertificateRegistration/provisionGlobalAppServicePrincipalInUserTenant/Action | 为服务应用主体预配服务主体 |
...
> | Microsoft.Maps/accounts/privateAtlases/delete | 删除 Private Atlas |
> | Microsoft.Maps/accounts/privateAtlases/read | 获取 Private Atlas |
> | Microsoft.Maps/accounts/privateAtlases/write | 创建或更新 Private Atlas |
...
> | Microsoft.Media/mediaservices/liveEventPrivateEndpointConnectionProxies/read | 读取任何直播活动专用终结点连接代理 |
> | Microsoft.Media/mediaservices/liveEventPrivateEndpointConnectionProxies/write | 创建直播活动专用终结点连接代理 |
> | Microsoft.Media/mediaservices/liveEventPrivateEndpointConnectionProxies/delete | 删除直播活动专用终结点连接代理 |
> | Microsoft.Media/mediaservices/liveEventPrivateEndpointConnectionProxies/validate/action | 验证直播活动专用终结点连接代理 |
> | Microsoft.Media/mediaservices/liveEventPrivateEndpointConnections/read | 读取任何直播活动专用终结点连接 |
> | Microsoft.Media/mediaservices/liveEventPrivateEndpointConnections/write | 创建直播活动专用终结点连接 |
> | Microsoft.Media/mediaservices/liveEventPrivateEndpointConnections/delete | 删除直播活动专用终结点连接 |
> | Microsoft.Media/mediaservices/liveEventPrivateLinkResources/read | 读取任何直播活动专用链接资源 |
...
> | Microsoft.Media/mediaservices/mediaGraphs/read | 读取任何媒体图 |
> | Microsoft.Media/mediaservices/mediaGraphs/write | 创建或更新任何媒体图 |
> | Microsoft.Media/mediaservices/mediaGraphs/delete | 删除任何媒体图 |
> | Microsoft.Media/mediaservices/mediaGraphs/start/action | 启动任何媒体图操作 |
> | Microsoft.Media/mediaservices/mediaGraphs/stop/action | 停止任何媒体图操作 |
...
> | Microsoft.Media/mediaservices/streamingEndpoints/streamingEndpointPrivateEndpointConnectionProxies/read | 读取任何流式处理终结点专用终结点连接代理 |
> | Microsoft.Media/mediaservices/streamingEndpoints/streamingEndpointPrivateEndpointConnectionProxies/write | 创建流式处理终结点专用终结点连接代理 |
> | Microsoft.Media/mediaservices/streamingEndpoints/streamingEndpointPrivateEndpointConnectionProxies/delete | 删除流式处理终结点专用终结点连接代理 |
> | Microsoft.Media/mediaservices/streamingEndpoints/streamingEndpointPrivateEndpointConnectionProxies/validate/action | 验证流式处理终结点专用终结点连接代理 |
> | Microsoft.Media/mediaservices/streamingEndpoints/streamingEndpointPrivateEndpointConnections/read | 读取任何流式处理终结点专用终结点连接 |
> | Microsoft.Media/mediaservices/streamingEndpoints/streamingEndpointPrivateEndpointConnections/write | 创建流式处理终结点专用终结点连接 |
> | Microsoft.Media/mediaservices/streamingEndpoints/streamingEndpointPrivateEndpointConnections/delete | 删除流式处理终结点专用终结点连接 |
> | Microsoft.Media/mediaservices/streamingEndpoints/streamngEndpointPrivateLinkResources/read | 读取任何流式处理终结点专用链接资源 |
...
> | Microsoft.Media/mediaservices/streamingPrivateEndpointConnectionOperations/read | 读取任何流式处理专用终结点连接操作 |
> | Microsoft.Media/mediaservices/streamingPrivateEndpointConnectionProxyOperations/read | 读取任何流式处理专用终结点连接代理操作 |
...
> | Microsoft.SignalRService/SignalR/delete | 删除整个 SignalR 服务 |
...
> | Microsoft.SignalRService/SignalR/restart/action | 通过管理门户或 API 重启 Azure SignalR 服务。 将会停机一段时间。 |
> | Microsoft.SignalRService/SignalR/eventGridFilters/read | 获取指定事件网格筛选器的属性，或列出指定 SignalR 的所有事件网格筛选器。 |
> | Microsoft.SignalRService/SignalR/eventGridFilters/write | 使用指定的参数创建或更新 SignalR 的事件网格筛选器。 |
> | Microsoft.SignalRService/SignalR/eventGridFilters/delete | 从 SignalR 中删除事件网格筛选器。 |
> | Microsoft.SignalRService/SignalR/privateEndpointConnectionProxies/validate/action | 验证专用终结点连接代理 |
> | Microsoft.SignalRService/SignalR/privateEndpointConnectionProxies/write | 创建专用终结点连接代理 |
...
> | Microsoft.SignalRService/SignalR/privateEndpointConnections/write | 批准或拒绝专用终结点连接 |
...
> | microsoft.web/sites/functions/properties/read | 读取 Web 应用函数属性。 |
> | microsoft.web/sites/functions/properties/write | 更新 Web 应用函数属性。 |
...
> | microsoft.web/sites/host/properties/read | 读取 Web 应用函数宿主属性。 |
...
> | 操作 | 说明 |
> | --- | --- |
> | Microsoft.DevSpaces/register/action | 将 Microsoft Dev Spaces 资源提供程序注册到订阅 |
> | Microsoft.DevSpaces/controllers/read | 读取 Azure Dev Spaces 控制器属性 |
> | Microsoft.DevSpaces/controllers/write | 创建或更新 Azure Dev Spaces 控制器属性 |
> | Microsoft.DevSpaces/controllers/delete | 删除 Azure Dev Spaces 控制器和数据平面服务 |
> | Microsoft.DevSpaces/controllers/listConnectionDetails/action | 列出 Azure Dev Spaces 控制器基础结构的连接详细信息 |
> | Microsoft.DevSpaces/locations/checkContainerHostMapping/action | 检查容器主机的现有控制器映射 |
> | Microsoft.DevSpaces/locations/checkContainerHostMapping/read | 检查容器主机的现有控制器映射 |
> | Microsoft.DevSpaces/locations/operationresults/read | 读取异步操作的状态 |
...
> | Microsoft.Cache/redis/stop/action | 停止缓存实例。 |
> | Microsoft.Cache/redis/start/action | 启动缓存实例。 |
...
> | Microsoft.DataFactory/factories/integrationruntimes/listauthkeys/read | 列出任何集成运行时的身份验证密钥。 |
...
> | Microsoft.DataMigration/services/stop/action | 停止 DMS 服务，将成本降至最低 |
> | Microsoft.DataMigration/services/start/action | 启动 DMS 服务，使其可以再次处理迁移 |
> | Microsoft.DataMigration/services/checkStatus/action | 检查服务是否已部署并正在运行 |
> | Microsoft.DataMigration/services/configureWorker/action | 将 DMS 辅助角色配置为服务的可用辅助角色 |
> | Microsoft.DataMigration/services/addWorker/action | 将 DMS 辅助角色添加到服务的可用辅助角色 |
> | Microsoft.DataMigration/services/removeWorker/action | 删除服务可用辅助角色的 DMS 辅助角色 |
> | Microsoft.DataMigration/services/updateAgentConfig/action | 使用提供的值更新 DMS 代理配置。 |
> | Microsoft.DataMigration/services/getHybridDownloadLink/action | 从 RP Blob 存储获取 DMS 辅助角色包下载链接。 |
...
> | Microsoft.DataMigration/skus/read | 获取 DMS 资源支持的 SKU 列表。 |
...
> | Microsoft.DBforMariaDB/locations/serverKeyAzureAsyncOperation/read | 获取正在对透明数据加密服务器密钥进行的操作 |
...
> | Microsoft.DBforMySQL/locations/serverKeyOperationResults/read | 获取正在对透明数据加密服务器密钥进行的操作 |
...
> | Microsoft.DBforPostgreSQL/locations/serverKeyAzureAsyncOperation/read | 获取正在对透明数据加密服务器密钥进行的操作 |
> | Microsoft.DBforPostgreSQL/locations/serverKeyOperationResults/read | 获取正在对透明数据加密服务器密钥进行的操作 |
...
Azure 服务：[SQL 数据仓库](../sql-data-warehouse/index.yml)
...
> | Microsoft.Sql/servers/disableAzureADOnlyAuthentication/action | 在逻辑服务器上禁用仅限 Azure Active Directory 的身份验证 |
...
> | Microsoft.Sql/servers/import/action | 在服务器上创建新数据库，并部署 DacPac 包中的架构和数据 |
...
> | Microsoft.Sql/servers/auditingPolicies/read | 检索在给定的服务器上配置的默认服务器表审核策略的详细信息 |
> | Microsoft.Sql/servers/auditingPolicies/write | 更改给定服务器的默认服务器表审核 |
...
> | Microsoft.Sql/servers/backupLongTermRetentionVaults/read | 此操作用于获取备份长期保留保管库。 它返回有关已注册到此服务器的保管库的信息 |
> | Microsoft.Sql/servers/backupLongTermRetentionVaults/write | 此操作用于将备份长期保留保管库注册到服务器 |
> | Microsoft.Sql/servers/backupLongTermRetentionVaults/delete | 删除现有备份存档保管库。 |
...
> | Microsoft.Sql/servers/databases/auditingPolicies/read | 检索在给定数据库上配置的表审核策略的详细信息 |
> | Microsoft.Sql/servers/databases/auditingPolicies/write | 更改给定数据库的表审核策略 |
...
> | Microsoft.Sql/servers/databases/connectionPolicies/read | 检索在给定数据库上配置的连接策略的详细信息 |
> | Microsoft.Sql/servers/databases/connectionPolicies/write | 更改给定数据库的连接策略 |
...
> | Microsoft.Sql/servers/databases/extensions/write | 更改给定数据库的扩展 |
...
> | Microsoft.Databricks/workspaces/storageEncryption/write | 在 Databricks 工作区的托管存储帐户中启用管理的密钥加密 |
> | Microsoft.Databricks/workspaces/storageEncryption/delete | 在 Databricks 工作区的托管存储帐户中禁用客户管理的密钥加密 |
...
> | Microsoft.HDInsight/clusters/changerdpsetting/action | 更改 HDInsight 群集的 RDP 设置 |
...
Azure 服务：[Power BI Embedded](/power-bi-embedded/)
...
> | Microsoft.CognitiveServices/accounts/ComputerVision/read/analyze/action | 使用此接口可以采用针对包含大量文本的文档优化的一流光学字符识别 (OCR) 算法执行读取操作。<br>它可以处理手写、打印或混合文档。<br>使用“读取”接口时，响应将包含名为“Operation-Location”的标头。<br>“Operation-Location”标头包含必须在“获取读取结果”操作中用来访问 OCR 结果的 URL。 |
...
> | Microsoft.CognitiveServices/accounts/FormRecognizer/custom/models/read | 获取有关模型的信息。 获取有关所有已训练的自定义模型的信息* |
> | Microsoft.CognitiveServices/accounts/FormRecognizer/custom/models/keys/read | 检索模型的密钥。 |
> | Microsoft.CognitiveServices/accounts/FormRecognizer/prebuilt/receipt/asyncbatchanalyze/action | 从给定的回执文档中提取字段文本和语义值。 输入图像文档必须是支持的内容类型之一 - JPEG、PNG、BMP、PDF 或 TIFF。 成功响应是一个 JSON，其中包含名为“Operation-Location”的字段，该字段包含“获取回执结果”操作以异步检索结果的 URL。 |
> | Microsoft.CognitiveServices/accounts/FormRecognizer/prebuilt/receipt/operations/action | 查询状态并检索“分析回执”操作的结果。 可从“分析回执”响应中的“Operation-Location”标头获取此接口的 URL。 |
...
> | Microsoft.CognitiveServices/accounts/InkRecognizer/recognize/action | 在提供一组笔划数据的情况下，分析其内容并生成一个已识别实体的列表，这些实体中包含已识别的文本。 |
...
> | Microsoft.MachineLearningServices/locations/updateQuotas/action | 更新工作区中每个 VM 系列的配额。 |
...
> | 操作 | 说明 |
> | --- | --- |
> | Microsoft.IoTSpaces/register/action | 注册 Microsoft.IoTSpaces Graph 资源提供程序的订阅，以便能够创建资源 |
> | Microsoft.IoTSpaces/Graph/write | 创建 Microsoft.IoTSpaces Graph 资源 |
> | Microsoft.IoTSpaces/Graph/read | 获取 Microsoft.IoTSpaces Graph 资源 |
> | Microsoft.IoTSpaces/Graph/delete | 删除 Microsoft.IoTSpaces Graph 资源 |
...
> | Microsoft.ApiManagement/service/portalsettings/listSecrets/action | 获取门户委托设置的验证密钥。 |
...
> | Microsoft.ApiManagement/service/tenant/read | 获取 API 管理服务的全局策略定义。 或获取租户访问详细信息 |
...
> | Microsoft.DataBoxEdge/skus/read | 列出或获取 SKU |
...
> | 操作 | 说明 |
> | --- | --- |
> | Microsoft.DataCatalog/register/action | 注册数据目录资源提供程序的订阅 |
> | Microsoft.DataCatalog/unregister/action | 取消注册数据目录资源提供程序的订阅 |
> | Microsoft.DataCatalog/catalogs/read | 读取数据目录资源提供程序的目录资源。 |
> | Microsoft.DataCatalog/catalogs/write | 写入数据目录资源提供程序的目录资源。 |
> | Microsoft.DataCatalog/catalogs/delete | 删除数据目录资源提供程序的目录资源。 |
> | Microsoft.DataCatalog/checkNameAvailability/read | 检查数据目录资源提供程序的目录名称可用性。 |
> | Microsoft.DataCatalog/datacatalogs/read | 读取数据目录资源提供程序的 DataCatalog 资源。 |
> | Microsoft.DataCatalog/datacatalogs/write | 写入数据目录资源提供程序的 DataCatalog 资源。 |
> | Microsoft.DataCatalog/datacatalogs/delete | 删除数据目录资源提供程序的 DataCatalog 资源。 |
> | Microsoft.DataCatalog/operations/read | 读取数据目录资源提供程序中的所有可用操作。 |
...
> | microsoft.aadiam/privateLinkForAzureAD/privateEndpointConnectionProxies/write | 创建和更新专用链接代理 |
...
> | Microsoft.ADHybridHealthService/services/servicemembers/action | 在服务中创建服务器实例。 |
...
> | Microsoft.KeyVault/vaults/write | 创建新的密钥保管库，或更新现有密钥保管库的属性 |
> | Microsoft.KeyVault/vaults/delete | 删除密钥保管库 |
> | Microsoft.KeyVault/vaults/deploy/action | 部署 Azure 资源时启用对密钥保管库中机密的访问 |
> | Microsoft.KeyVault/vaults/accessPolicies/write | 通过合并或替换操作更新现有的访问策略，或者将新的访问策略添加到保管库。 |
...
> | Microsoft.KeyVault/vaults/certificates/delete | 删除证书。 |
...
> | Microsoft.KeyVault/vaults/certificates/create/action | 创建新证书。 |
> | Microsoft.KeyVault/vaults/certificates/import/action | 将包含私钥的现有有效证书导入 Azure Key Vault。 要导入的证书可以采用 PFX 或 PEM 格式。 |
> | Microsoft.KeyVault/vaults/certificates/recover/action | 恢复已删除的证书。 该操作与 Delete 操作相反。 该操作在启用了软删除的保管库中适用，必须在保留间隔内发出。 |
> | Microsoft.KeyVault/vaults/certificates/restore/action | 将已备份的证书及其所有版本还原到保管库。 |
...
> | Microsoft.KeyVault/vaults/keys/create/action | 创建新密钥。 |
> | Microsoft.KeyVault/vaults/keys/import/action | 导入外部创建的密钥，存储它，然后将密钥参数和属性返回给客户端。 |
> | Microsoft.KeyVault/vaults/keys/recover/action | 恢复已删除的密钥。 该操作与 Delete 操作相反。 该操作在启用了软删除的保管库中适用，必须在保留间隔内发出。 |
> | Microsoft.KeyVault/vaults/keys/restore/action | 将已备份的密钥及其所有版本还原到保管库。 |
> | Microsoft.KeyVault/vaults/keys/delete | 删除密钥。 |
...
> | Microsoft.KeyVault/vaults/keys/decrypt/action | 使用密钥解密加密文本。 |
> | Microsoft.KeyVault/vaults/keys/wrap/action | 使用 Key Vault 密钥包装对称密钥。 请注意，如果 Key Vault 密钥为非对称密钥，则可以使用读取访问权限执行此操作。 |
> | Microsoft.KeyVault/vaults/keys/unwrap/action | 使用 Key Vault 密钥解包对称密钥。 |
> | Microsoft.KeyVault/vaults/keys/sign/action | 使用密钥签名哈希。 |
> | Microsoft.KeyVault/vaults/keys/verify/action | 验证哈希。 请注意，如果密钥为非对称密钥，此操作可以由拥有读取访问权限的主体执行。 |
> | Microsoft.KeyVault/vaults/secrets/delete | 删除机密。 |
...
> | Microsoft.KeyVault/vaults/secrets/restore/action | 将已备份的机密及其所有版本还原到保管库。 |
> | Microsoft.KeyVault/vaults/secrets/readMetadata/action | 列出或查看机密的属性，但不列出或查看机密的值。 |
> | Microsoft.KeyVault/vaults/secrets/getSecret/action | 获取机密值。 |
> | Microsoft.KeyVault/vaults/secrets/setSecret/action | 创建新机密。 |
...
> | 操作 | 说明 |
> | --- | --- |
> | Microsoft.LabServices/register/action | 注册订阅 |
...
> | Microsoft.AlertsManagement/alerts/diagnostics/read | 获取警报的所有诊断 |
...
> | Microsoft.OperationalInsights/linkTargets/read | 列出不与 Azure 订阅关联的现有帐户。 若要将此 Azure 订阅链接到工作区，请使用此操作在“创建工作区”操作的客户 ID 属性中返回的客户 ID。 |
...
> | microsoft.operationalinsights/workspaces/dataexport/read | 获取特定的数据导出。 |
> | microsoft.operationalinsights/workspaces/dataexport/write | 创建或更新数据导出。 |
> | microsoft.operationalinsights/workspaces/dataexport/delete | 删除特定的数据导出。 |
...
> | Microsoft.OperationalInsights/workspaces/query/ReservedCommonFields/read | 从 ReservedCommonFields 表读取数据 |
...
> | Microsoft.OperationalInsights/workspaces/query/SqlThreatProtectionLoginAudits/read | 从 SqlThreatProtectionLoginAudits 表读取数据 |
...
> | 操作 | 说明 |
> | --- | --- |
> | Microsoft.WorkloadMonitor/components/read | 获取资源的组件 |
> | Microsoft.WorkloadMonitor/componentsSummary/read | 获取组件的摘要 |
> | Microsoft.WorkloadMonitor/monitorInstances/read | 获取资源的监视器实例 |
> | Microsoft.WorkloadMonitor/monitorInstancesSummary/read | 获取监视器实例的摘要 |
> | Microsoft.WorkloadMonitor/monitors/read | 获取资源的监视器 |
> | Microsoft.WorkloadMonitor/monitors/write | 配置资源的监视器 |
> | Microsoft.WorkloadMonitor/notificationSettings/read | 获取资源的通知设置 |
> | Microsoft.WorkloadMonitor/notificationSettings/write | 配置资源的通知设置 |
> | Microsoft.WorkloadMonitor/operations/read | 获取支持的操作 |
...
> | Microsoft.Commerce/UsageAggregates/read | 检索订阅的 Azure 使用情况。 结果包含特定时间范围内的聚合用量数据、订阅和资源相关信息。 |
...
> | **DataAction** | **说明** |
> | Microsoft.PolicyInsights/checkDataPolicyCompliance/action | 根据数据策略检查给定组件的符合性状态。 |
...
> | 操作 | 说明 |
> | --- | --- |
> | Microsoft.BingMaps/updateCommunicationPreference/action | 更新 Microsoft.BingMaps 所有者的通信首选项 |
> | Microsoft.BingMaps/listCommunicationPreference/action | 获取 Microsoft.BingMaps 所有者的通信首选项 |
> | Microsoft.BingMaps/mapApis/Read | 获取 Microsoft.BingMaps/mapApis 的资源 |
> | Microsoft.BingMaps/mapApis/Write | 更新 Microsoft.BingMaps/mapApis 的资源 |
> | Microsoft.BingMaps/mapApis/Delete | 删除 Microsoft.BingMaps/mapApis 的资源 |
> | Microsoft.BingMaps/mapApis/regenerateKey/action | 重新生成 Microsoft.BingMaps/mapApis 的密钥 |
