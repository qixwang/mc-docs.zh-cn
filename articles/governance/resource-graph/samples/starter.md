...
了解使用 Azure 资源图表进行查询的第一步是对[查询语言](../concepts/query-language.md)有基本的了解。 如果还不熟悉 [Kusto 查询语言 (KQL)](https://docs.microsoft.com/azure/kusto/query/index)，建议查看 [KQL 的教程](https://docs.microsoft.com/azure/kusto/query/tutorial)，了解如何撰写所需资源的请求。
...
此查询扩展了该模式，以仅包括 properties.ipAddress 为  的结果，仅返回 properties.ipAddress，并将结果
为前 100 名`isnotempty` `limit`
