...
使用 Get-AzManagementGroup 命令可检索所有组。 请参阅 [Az.Resources](https://docs.microsoft.com/powershell/module/az.resources/Get-AzManagementGroup) 模块，查看管理组 GET PowerShell 命令的完整列表。  
