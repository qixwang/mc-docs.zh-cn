...
manager: carmonm
ms.openlocfilehash: 03e63764290d8ba1ef231ab25470601a153fc310
ms.sourcegitcommit: 4a09701b1cbc1d9ccee46d282e592aec26998bff
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/25/2019
ms.locfileid: "75335808"
---
...
名称中附加有 **\[\*\]** 的别名表示**类型**为“数组”。  指定 **\[\*\]** 可以评估数组的每个元素，而不会评估整个数组的值。 这种按项计算的功能在三种标准方案中非常有用：None、Any 和 All。 对于复杂方案，请使用 [count](../concepts/definition-structure.md#count)。
