...
> [!NOTE]
> Visual Studio 2019 中不支持 Windows 应用商店和 Windows Phone 项目 8.1 及更早的版本。 有关详细信息，请参阅 [Visual Studio 2019 平台目标以及兼容性](https://docs.microsoft.com/visualstudio/releases/2019/compatibility)。
