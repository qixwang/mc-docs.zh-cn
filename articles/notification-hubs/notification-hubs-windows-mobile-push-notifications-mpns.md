...
5. 在 `Application_Launching` 中的 `App.xaml.cs` 方法顶部添加以下代码：
...
6. 在解决方案资源管理器中，展开“属性”，打开 **文件，单击“功能”选项卡并确保选中**ID_CAP_PUSH_NOTIFICATION`WMAppManifest.xml` 功能。   应用现在可以接收推送通知了。
