...
ms.date: 03/09/2020
ms.author: v-yiso
ms.openlocfilehash: baa18c5c900bd3f5add571491f2dcdfc1ca69173
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "78155320"
---
...
* 合作伙伴可将[基于角色的访问控制](/role-based-access-control/overview)应用于 expressRouteCrossConnection 资源。 这些控制可以定义有关哪些用户帐户可以修改 expressRouteCrossConnection 资源以及添加/更新/删除对等互连配置的权限。
...
若要访问 expressRouteCrossConnections API，需要在 **Microsoft.Network 资源提供程序**中注册合作伙伴订阅。 遵循 [Azure 资源提供程序和类型](/azure-resource-manager/management/resource-providers-and-types#azure-portal)一文中的步骤完成注册过程。
...
成功配置身份验证后，需要在 Dev_Provider_Sub 下向网络参与者授予对客户端应用程序的访问权限。 若要授予权限，请登录到 [Azure 门户](https://ms.portal.azure.cn/#home)并完成以下步骤：
