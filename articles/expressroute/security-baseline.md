...
ms.openlocfilehash: 8673e1ada42408f09f2a3d241ed9e56636b28c9b
ms.sourcegitcommit: 091c672fa448b556f4c2c3979e006102d423e9d7
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/24/2020
ms.locfileid: "87162856"
---
...
* [了解 Azure ExpressRoute 网关要求](/vpn-gateway/vpn-gateway-about-vpn-gateway-settings#requirements)
...
* [了解 Azure ExpressRoute 的安全控制](/expressroute/expressroute-security-controls)

* [如何配置 DDoS 防护](/virtual-network/manage-ddos-protection)
...
* [了解 ExpressRoute 中的监视和警报](/expressroute/expressroute-monitoring-metrics-alerts)
...
* [利用 ExpressRoute 合作伙伴资源管理器 API 中的 RBAC](/expressroute/cross-connections-api-developmentment)
...
* [如何通过 ExpressRoute 配置站点到站点 IPSEC](/expressroute/site-to-site-vpn-over-microsoft-peering)
...
* [利用 ExpressRoute 合作伙伴资源管理器 API 中的 RBAC](/expressroute/cross-connections-api-development)

* [了解 ExpressRoute 中的管理角色](/expressroute/expressroute-howto-linkvnet-portal-resource-manager#connect-a-vnet-to-a-circuit---different-subscription)
...
* [了解 Azure ExpressRoute 中的点到点加密](/expressroute/expressroute-about-encryption)

* [如何在 ExpressRoute Direct 端口上配置 MACsec](/expressroute/expressroute-howto-macsec)

* [Key Vault 的 Azure 安全基线](/key-vault/general/security-baseline)
...
* [如何创建 Key Vault 实例以在新资源组中存储 MACsec 机密](/expressroute/expressroute-howto-macsec)
...
* [如何在配置 MACsec 后测试 Azure ExpressRoute 线路的连接](/expressroute/expressroute-howto-macsec)
