...
* **Azure Active Directory (Azure AD)** – Azure AD 提供针对 Microsoft Azure 和第三方 SaaS 应用程序的标识管理。 有关 Azure AD 的详细信息，请参阅 [此处](/active-directory/)。  
...
使用云解决方案提供商服务，可以在不需要购买昂贵的基础结构和功能的情况下，提升你对客户的价值，让你一直充当主要的外包提供商。 可以通过 CSP API 实现与 Microsoft Azure 的无缝集成，让你在现有的管理框架内集成对 Azure 的管理功能。  
