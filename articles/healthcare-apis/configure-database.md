...
ms.date: 11/15/2019
ms.author: matjazl
ms.openlocfilehash: de33286f2a225e2b716d2412aa8a4f806b35dcf0
ms.sourcegitcommit: 6ddc26f9b27acec207b887531bea942b413046ad
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/27/2020
ms.locfileid: "80343865"
---
...
在设置底层数据库的性能时，Azure API for FHIR 将借用 Cosmos DB 中 RU 的概念（请参阅 [Azure Cosmos DB 中的请求单位](https://docs.azure.cn/cosmos-db/request-units)）。 
