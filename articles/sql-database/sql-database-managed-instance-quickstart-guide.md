...
作为手动创建托管实例的替代方法，可使用 [PowerShell](scripts/sql-database-create-configure-managed-instance-powershell.md)、[带资源管理器模板的 PowerShell](scripts/sql-managed-instance-create-powershell-azure-resource-manager-template.md) 或 [Azure CLI](/cli/sql/mi#az-sql-mi-create) 来编写脚本并自动执行此过程。
