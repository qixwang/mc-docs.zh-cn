...
ms.date: 06/15/2020
ms.openlocfilehash: 9ef65914703833743fd7d0d860c8c6a506421825
ms.sourcegitcommit: 3de7d92ac955272fd140ec47b3a0a7b1e287ca14
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/12/2020
ms.locfileid: "84723108"
---
...
> [!IMPORTANT]
> 对于 Azure SQL 数据库托管实例，请参阅[托管实例的 LTR 支持](sql-database-long-term-retention.md#managed-instance-support)。
