...
ms.openlocfilehash: 5f277e161751f2dd09510678faabf0a67a16606b
ms.sourcegitcommit: 3de7d92ac955272fd140ec47b3a0a7b1e287ca14
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/12/2020
ms.locfileid: "84723155"
---
...
- 除在服务器上启用审核外，在数据库或数据仓库上启用审核也不会替代或更改服务器审核的任何设置。** 这两种审核会并存。 换言之，会并行对数据库执行两次审核；一次按服务器策略审核，一次按数据库策略审核。
