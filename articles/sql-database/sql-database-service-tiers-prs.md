...
基于 vCore 的购买模型中的服务层级享受特惠套餐，与许可证涵盖的定价相比，最多可将成本节省 80%。 与附带[面向 SQL Server 的 Azure 混合权益](https://azure.cn/pricing/hybrid-benefit/)的许可证涵盖定价相比，附带积极软件保障的 SQL Server Standard 或 Enterprise 版许可证最多可将成本节省 55%。
