...
ms.date: 06/15/2020
ms.openlocfilehash: 4a52fd2d27677c712596db0dc2d9ca83221dde8a
ms.sourcegitcommit: 3de7d92ac955272fd140ec47b3a0a7b1e287ca14
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/12/2020
ms.locfileid: "84723664"
---
...
> [!IMPORTANT]
> 警报指标仅适用于托管实例。 警报指标不适用于托管实例中的单个数据库。 另一方面，数据库诊断遥测可按[诊断日志](sql-database-metrics-diag-logging.md#diagnostic-telemetry-for-export-for-azure-sql-database)的形式提供。
...
1. 在 Azure [门户](https://portal.azure.cn/)中，查找想要监视的 SQL 托管实例，然后将其选中。
