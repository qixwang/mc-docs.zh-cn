...
ms.date: 03/30/2020
ms.openlocfilehash: caa062accdcfaa7ab00916fa596d72a7e2b6961a
ms.sourcegitcommit: 90660563b5d65731a64c099b32fb9ec0ce2c51c6
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/27/2020
ms.locfileid: "80341738"
---
...
|列存储支持|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|不适用|不适用|不适用|空值|不适用|
...
|列存储支持|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|不适用|不适用|空值|不适用|空值|空值|
...
|最大日志速率 (MBps)|105 |105 |105 |105 |105 |105 |
...
|Multi-AZ|不适用|不适用|不适用|空值|空值|不适用|
|读取横向扩展|是|是|是|是|是|是|
...
|[RBPEX](sql-database-service-tier-hyperscale.md#compute) 大小|3 倍内存|3 倍内存|3 倍内存|3 倍内存|3 倍内存|3 倍内存|
|列存储支持|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|空值|不适用|空值|空值|不适用|不适用|
|最大数据大小 (TB)|100 |100 |100 |100 |100 |100 |
|最大日志大小 (TB)|1 |1 |1 |1 |1 |1 |
...
|最大并发会话数|30,000|30,000|30,000|30,000|30,000|30,000|
|次要副本|0-4|0-4|0-4|0-4|0-4|0-4|
|Multi-AZ|不适用|不适用|不适用|空值|不适用|不适用|
|读取横向扩展|是|是|是|是|是|是|
|备份存储保留期|7 天|7 天|7 天|7 天|7 天|7 天|
|||
...
|列存储支持|是|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|不适用|不适用|不适用|不适用|不适用|空值|不适用|
...
|最大日志速率 (MBps)|105 |105 |105 |105 |105 |105 |105 |
...
|Multi-AZ|不适用|空值|不适用|空值|不适用|空值|不适用|
...
|[RBPEX](sql-database-service-tier-hyperscale.md#compute) 大小|3 倍内存|3 倍内存|3 倍内存|3 倍内存|3 倍内存|3 倍内存|3 倍内存|
|列存储支持|是|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|空值|不适用|不适用|空值|空值|空值|空值|
|最大数据大小 (TB)|100 |100 |100 |100 |100 |100 |100 |
|最大日志大小 (TB)|1 |1 |1 |1 |1 |1 |1 |
...
|最大并发会话数|30,000|30,000|30,000|30,000|30,000|30,000|30,000|
|次要副本|0-4|0-4|0-4|0-4|0-4|0-4|0-4|
|Multi-AZ|不适用|不适用|不适用|不适用|不适用|空值|空值|
|读取横向扩展|是|是|是|是|是|是|是|
|备份存储保留期|7 天|7 天|7 天|7 天|7 天|7 天|7 天|
|||
...
|内存 (GB)|7|14|21|28|35|42|
|列存储支持|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|不适用|空值|不适用|空值|不适用|不适用|
...
|内存 (GB)|49|56|63|70|112|159.5|
|列存储支持|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|不适用|空值|空值|空值|不适用|空值|
...
|内存 (GB)|10.4|20.8|31.1|41.5|51.9|62.3|72.7|
|列存储支持|是|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|空值|不适用|不适用|空值|不适用|不适用|不适用|
...
|最大并发会话数|30,000|30,000|30,000|30,000|30,000|30,000|30,000|
|副本数|1|1|1|1|1|1|1|
|Multi-AZ|不适用|空值|不适用|不适用|不适用|不适用|空值|
|读取横向扩展|不适用|不适用|空值|空值|空值|不适用|不适用|
...
|内存 (GB)|83|93.4|103.8|124.6|166.1|207.6|415.2|
|列存储支持|是|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|空值|不适用|不适用|空值|空值|不适用|不适用|
...
|最大并发会话数|30,000|30,000|30,000|30,000|30,000|30,000|30,000|
|副本数|1|1|1|1|1|1|1|
|Multi-AZ|不适用|不适用|不适用|不适用|不适用|不适用|空值|
|读取横向扩展|不适用|不适用|空值|不适用|空值|不适用|不适用|
|随附的备份存储|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|
