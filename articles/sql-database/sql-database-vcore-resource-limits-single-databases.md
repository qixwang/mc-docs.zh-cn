...
ms.date: 04/27/2020
ms.openlocfilehash: 81681582d54d01aefc5dc4bb7a7adbd6502b8432
ms.sourcegitcommit: a4a2521da9b29714aa6b511fc6ba48279b5777c8
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/24/2020
ms.locfileid: "82126805"
---
...
|副本数|1|1|1|1|
|Multi-AZ|空值|不适用|空值|不适用|
|读取横向扩展|不适用|空值|空值|不适用|
...
|列存储支持|是|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|空值|空值|不适用|空值|不适用|空值|空值|
...
|Multi-AZ|空值|不适用|不适用|空值|不适用|空值|空值|
...
|[RBPEX](sql-database-service-tier-hyperscale.md#compute) 大小|3 倍内存|3 倍内存|3 倍内存|3 倍内存|3 倍内存|3 倍内存|3 倍内存|
|列存储支持|是|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|不适用|空值|空值|空值|空值|不适用|空值|
|最大数据大小 (TB)|100 |100 |100 |100 |100 |100 |100 |
|最大日志大小 (TB)|1 |1 |1 |1 |1 |1 |1 |
...
|最大并发会话数|30,000|30,000|30,000|30,000|30,000|30,000|30,000|
|次要副本|0-4|0-4|0-4|0-4|0-4|0-4|0-4|
|Multi-AZ|空值|不适用|空值|空值|空值|空值|空值|
|读取横向扩展|是|是|是|是|是|是|是|
|备份存储保留期|7 天|7 天|7 天|7 天|7 天|7 天|7 天|
|||
...
|内存 (GB)|49|56|63|70|112|159.5|
|列存储支持|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|不适用|空值|不适用|不适用|空值|不适用|
...
|最大并发会话数|30,000|30,000|30,000|30,000|30,000|30,000|
|副本数|1|1|1|1|1|1|
|Multi-AZ|空值|空值|不适用|不适用|不适用|空值|
|读取横向扩展|空值|空值|不适用|空值|不适用|空值|
|随附的备份存储|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|
...
|内存 (GB)|10.4|20.8|31.1|41.5|51.9|62.3|72.7|
|列存储支持|是|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|不适用|空值|不适用|不适用|空值|空值|空值|
