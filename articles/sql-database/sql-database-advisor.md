...
ms.date: 12/16/2019
ms.openlocfilehash: be18a4bd8ccd36054018611cf7a794df3ae0b828
ms.sourcegitcommit: 4a09701b1cbc1d9ccee46d282e592aec26998bff
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/25/2019
ms.locfileid: "75336142"
---
...
> [!TIP]
> [自动优化](sql-database-automatic-tuning.md)是自动优化一些最常见的数据库性能问题的建议方法。 [查询性能见解](sql-database-query-performance.md)是针对基本 Azure SQL 数据库性能监视需求的建议方法。
>
