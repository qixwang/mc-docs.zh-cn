...
如果没有 Azure 订阅，可[创建一个 1 元人民币试用帐户](https://www.azure.cn/en-us/pricing/1rmb-trial-full/?form-type=identityauth)。
...
2. 在“概述”选项卡上，找到“主机”属性。   复制托管实例的主机名，该名称可在下一个快速入门中使用。
   ...
   复制的值表示可用于连接到托管实例的完全限定域名 (FQDN)。 FQDN 类似于以下地址示例：your_host_name.a1b2c3d4e5f6.database.chinacloudapi.cn  。
