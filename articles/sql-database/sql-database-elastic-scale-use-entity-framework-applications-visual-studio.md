...
此文档介绍与[弹性数据库工具](sql-database-elastic-scale-introduction.md)集成所需的实体框架应用程序中的更改。 重点是使用 Entity Framework [Code First](sql-database-elastic-scale-shard-map-management.md) 方法撰写[分片映射管理](sql-database-elastic-scale-data-dependent-routing.md)和**数据相关路由**。 EF 的 [Code First – 新数据库](https://msdn.microsoft.com/data/jj193542.aspx)教程在本文档中充当运行示例。 本文档附带的示例代码是 Visual Studio 代码示例中弹性数据库工具示例的一部分。
