...
Azure SQL 构建在 Microsoft SQL Server 上，旨在提供高可用性、高性能和可缩放的服务。 在本地运行的专有数据库上使用 SQL Azure 有很多优势。 使用 SQL Azure 时，需要安装、设置、维护或管理的不是数据库，而是数据库的内容和结构。 数据库中内置了容错和冗余等，这些都是我们担心的典型问题。 
...
## <a name="step-3--add-your-ip-to-the-firewall"></a><a id="Firewall"></a>步骤 3：添加 IP 到防火墙
...
也许你还不知道，Visual Studio 现在也允许开发 C++ Linux 应用程序。 可以在 [Visual C++ for Linux Development](https://blogs.msdn.microsoft.com/vcblog/20../../visual-c-for-linux-development/)（用于 Linux 开发的 Visual C++）博客中阅读此新方案。 要针对 Linux 构建，将需要一台运行 Linux 发行版的远程计算机。 如果没有可用的远程计算机，可以使用 [Linux Azure 虚拟机](../virtual-machines/linux/quick-create-cli.md)快速设置。 
...
## <a name="get-the-complete-cc-tutorial-solution"></a><a id="GetSolution"></a>获取完整版 C/C++ 教程解决方案
