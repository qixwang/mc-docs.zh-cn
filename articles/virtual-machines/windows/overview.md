...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 087eb55c043b09f922aa4e59927ccedfb1cf4e1d
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "77428767"
---
...
* **收集诊断数据** – 可以借助 [Azure 诊断扩展](extensions-diagnostics-template.md?toc=%2fvirtual-machines%2fwindows%2ftoc.json) 将 VM 配置为收集诊断数据，并可以使用这些数据监视应用程序的运行状况。
