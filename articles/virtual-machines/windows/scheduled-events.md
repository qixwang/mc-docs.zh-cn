...
<!--MOONCAKE: Low-priority WAS NOT INTRODUCE ON MOONCAKE-->
<!--Not Available on Table Line 4 | 2017-11-01 | General Availability | All | <li> Added support for Low-priority VM eviction EventType 'Preempt'<br /> |-->
