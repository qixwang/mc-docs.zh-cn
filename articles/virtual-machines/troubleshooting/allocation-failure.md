...
如果本文未解决你的 Azure 问题，请访问 [Azure 支持](https://support.azure.cn/zh-cn/support/contact)。 此外，还可以在 [Azure 支持](https://support.windowsazure.cn/support/support-azure)站点上发出 Azure 支持请求。
