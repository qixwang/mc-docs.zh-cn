...
如果尚未安装 [Azure CLI](https://docs.azure.cn/cli/install-az-cli2?view=azure-cli-latest)，请安装。
...
2. 使用 [az login](https://docs.azure.cn/cli/reference-index?view=azure-cli-latest#az-login) 登录到 Azure 帐户。
3. 停止并解除分配 VM。
