...
6. 将 Debian 的 Azure 存储库添加到 Debian 8 或 9 的 /etc/apt/sources.list 中：
    ...
    **Debian 8.x "Jessie"**
        ...
        deb http://debian-archive.trafficmanager.cn/debian jessie main
        deb-src http://debian-archive.trafficmanager.cn/debian jessie main
        deb http://debian-archive.trafficmanager.cn/debian-security jessie/updates main
        deb-src http://debian-archive.trafficmanager.cn/debian-security jessie/updates
        deb http://debian-archive.trafficmanager.cn/debian jessie-updates main
        deb-src http://debian-archive.trafficmanager.cn/debian jessie-updates main
    ...
    **Debian 9.x "Stretch"**
        ...
        deb http://debian-archive.trafficmanager.cn/debian stretch main
        deb-src http://debian-archive.trafficmanager.cn/debian stretch main
        deb http://debian-archive.trafficmanager.cn/debian-security stretch/updates main
        deb-src http://debian-archive.trafficmanager.cn/debian-security stretch/updates main
        deb http://debian-archive.trafficmanager.cn/debian stretch-updates main
        deb-src http://debian-archive.trafficmanager.cn/debian stretch-updates main
        deb http://debian-archive.trafficmanager.cn/debian stretch-backports main
        deb-src http://debian-archive.trafficmanager.cn/debian stretch-backports main
