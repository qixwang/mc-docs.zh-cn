...
可通过安装并使用 [Azure CLI](https://docs.azure.cn/cli/?view=azure-cli-latest) 命令行工具在加密的 VHD 上启用磁盘加密。 可以在本地计算机上安装 PowerShell，并在任何 PowerShell 会话中使用它。 若要在 Azure 中现有或正在运行的 Linux VM 上启用加密，请使用以下 CLI 命令：

<!--MOONCAKE: Not Available on  [Azure Cloud Shell](../../cloud-shell/overview.md)-->

使用 [az vm encryption enable](https://docs.azure.cn/cli/vm/encryption?view=azure-cli-latest#az-vm-encryption-show) 命令在 Azure 中运行的虚拟机上启用加密。
...
- **验证磁盘是否已加密：** 若要检查 VM 的加密状态，请使用 [az vm encryption show](https://docs.azure.cn/cli/vm/encryption?view=azure-cli-latest#az-vm-encryption-show) 命令。 
...
1. 在 Azure 快速入门模板中，单击“部署到 Azure”。 
    ...
    [![“部署到 Azure”](http://azuredeploy.net/deploybutton.png)](https://portal.azure.cn/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fazure%2Fazure-quickstart-templates%2Fmaster%2F201-encrypt-running-linux-vm-without-aad%2Fazuredeploy.json)
    ...
    <!--URL CORRECT ON https://portal.azure.cn/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fazure%2Fazure-quickstart-templates%2Fmaster%2F201-encrypt-running-linux-vm-without-aad%2Fazuredeploy.json-->
