...
在本快速入门教程中，你将使用 Azure 门户创建装有 SQL Server 2019 的 Linux 虚拟机。
...
1. 在“大小”  选项卡中，选择计算机大小。 有关 VM 计算机大小的详细信息，请参阅 [Linux VM 大小](/virtual-machines/virtual-machines-linux-sizes)。
...
在 Azure 中有了 SQL Server 2019 虚拟机以后，即可使用 sqlcmd 进行本地连接，以便运行 Transact-SQL 查询。 
...
有关 Linux 上的 SQL Server 的更多一般信息，请参阅 [Linux 上的 SQL Server 2019 概述](https://docs.microsoft.com/sql/linux/sql-server-linux-overview)。 若要详细了解如何使用 SQL Server 2019 Linux 虚拟机，请参阅 [Azure 上的 SQL Server 2019 虚拟机概述](sql-server-linux-virtual-machines-overview.md)。
