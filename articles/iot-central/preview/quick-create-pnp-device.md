...
还需要包含 IoT 即插即用设备功能模型的 **EnvironmentalSensorInline.capabilitymodel.json** 文件的本地副本。 可以从[此处](https://raw.githubusercontent.com/Azure/IoTPlugandPlay/master/samples/EnvironmentalSensorInline.capabilitymodel.json)下载它。 在页面上单击右键，然后选择“另存为”。 
