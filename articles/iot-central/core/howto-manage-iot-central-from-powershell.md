...
ms.topic: conceptual
manager: philmea
ms.openlocfilehash: 60dcad17fc2dfbc3f480a7da91ec146bbb3a9d85
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "80343180"
---
...
该脚本首先在“中国东部”区域中为应用程序创建一个资源组。 下表描述了与 **New-AzIotCentralApp** 命令配合使用的参数：

|参数         |说明 |
|------------------|------------|
|ResourceGroupName |包含该应用程序的资源组。 此资源组必须已存在于订阅中。 |
|位置 |此 cmdlet 默认使用资源组中的位置。|
