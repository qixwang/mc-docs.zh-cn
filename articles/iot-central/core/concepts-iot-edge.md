...
ms.openlocfilehash: 32f42c3a41ac66ba2101ca3c8a9f05b832608041
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "80343739"
---
...
在 Azure IoT Central 中，可以导入部署清单以创建设备模板。 以下流程图显示了 IoT Central 中的部署清单生命周期。

![部署清单生命周期的流程图](./media/concepts-iot-edge/dmflow.png)

IoT 即插即用（预览版）为 IoT Edge 设备建模，如下所示：
