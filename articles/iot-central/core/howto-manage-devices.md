...
1. 在左侧窗格中选择“设备”  。 此处会显示[设备模板](howto-set-up-template.md)的列表。
...
有关连接字符串以及如何将实际设备连接到 IoT Central 应用程序的详细信息，请参阅 [Azure IoT Central 中的设备连接](concepts-connectivity.md)。
