...
本文的其余部分介绍如何使用[媒体服务 v3 CLI](/cli/ams?view=azure-cli-latest) 来缩放 MRU。
...
以下 [az ams account mru](/cli/ams/account/mru?view=azure-cli-latest) 命令使用 **count** 和 **type** 参数在“amsaccount”帐户上设置媒体预留单位。
