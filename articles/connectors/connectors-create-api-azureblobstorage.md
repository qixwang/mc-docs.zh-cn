...
<!--Not Avaiable on [integration service environment (ISE)](../logic-apps/connect-virtual-network-vnet-isolated-environment-overview.md)-->
<!--Not Avaiable on [ISE message limits](../logic-apps/logic-apps-limits-and-config.md#message-size-limits)-->
...
<!--Not Avaialble on ### Access storage accounts through a trusted virtual network-->
