...
ms.author: v-johya
ms.date: 07/15/2020
ms.openlocfilehash: a9f4fb8246ed95a98eb261dd417739e05db22dfa
ms.sourcegitcommit: 403db9004b6e9390f7fd1afddd9e164e5d9cce6a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/17/2020
ms.locfileid: "86440574"
---
...
- [Microsoft.OperationalInsights workspaces/savedSearches](https://docs.microsoft.com/azure/templates/microsoft.operationalinsights/2020-03-01-preview/workspaces/savedsearches)

## <a name="simple-log-query"></a>简单日志查询
...
## <a name="log-query-as-a-function"></a>函数形式的日志查询
...
## <a name="parameterized-function"></a>参数化函数
...
* [详细了解日志查询](../log-query/log-query-overview.md)。
* [详细了解函数](../log-query/functions.md)。
