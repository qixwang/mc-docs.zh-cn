...
ms.author: v-johya
ms.date: 07/15/2020
ms.openlocfilehash: 950c309e344a7687b3455b34d7a36140704220ec
ms.sourcegitcommit: 403db9004b6e9390f7fd1afddd9e164e5d9cce6a
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/17/2020
ms.locfileid: "86440579"
---
...
```json
{
  ...
  "parameters": {
    ...
    "aksResourceLocation": {
      "type": "string",
      "metadata": {
        "description": "Location of the AKS resource e.g. \"ChinaNorth\""
      }
    },
  ...
  "resources": [
    {
      ...
      "properties": {
        ...
        "fqdn": "[concat(parameters('clusterName'), '.', parameters('location'), '.', 'chinacloudapp.cn')]",
        "networkProfile": {
          "vnetCidr": "10.0.0.0/8"
        },
        "authProfile": {
...
```json
{
  ...
  "parameters": {
    ...
    "aroResourceLocation": {
      "type": "string",
      "metadata": {
        "description": "Location of the aro cluster resource e.g. chinanorth"
      }
    },
    "workspaceResourceId": {
      "type": "string",
