...
ms.openlocfilehash: 39e765b6c1a251e2397bb3bd770107061329a444
ms.sourcegitcommit: 5ae04a3b8e025986a3a257a6ed251b575dbf60a1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/05/2020
ms.locfileid: "84440585"
---
...
> [!NOTE]
> 还可以使用[通用警报架构](/azure-monitor/platform/alerts-common-schema)进行 Webhook 集成。 通用警报架构的优点是可以跨 Azure Monitor 中的所有警报服务提供单个可扩展且统一的警报有效负载。 [了解常见的警报架构定义。](/azure-monitor/platform/alerts-common-schema-definitions)
