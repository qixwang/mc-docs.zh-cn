---
title: 将 Windows 计算机连接到 Azure Monitor
...
在安装适用于 Windows 的 Log Analytics 代理前，需要先获得 Log Analytics 工作区的工作区 ID 和秘钥。  安装期间每种安装方法都需要此信息才能正确配置代理，并确保它能与中国云中的 Azure Monitor 成功通信。 
