...
> [!NOTE]
> 下表的底部可能会显示水平滚动条。 如果你觉得缺少了信息，请检查滚动条是否靠住最左侧。  


| 是否可通过诊断设置导出？  | 已发出 NULL |  ResourceType  |  指标  |  MetricDisplayName  |  计价单位  |  AggregationType | 
|---|---| ---- | ----- | ------ | ---- | ---- | 
...
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  private_bytes_metric  |  专用字节数  |  字节  |  平均值 | 
...
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  QueryPoolBusyThreads  |  查询池忙线程数  |  计数  |  平均值 | 
...
| **是**  | **是** |  Microsoft.Devices/Account  |  digitaltwins.telemetry.nodes  |  数字孪生节点遥测占位符  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.read.failure  |  后端的失败孪生读取数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.read.size  |  后端的孪生读取的响应大小  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.read.success  |  后端的成功孪生读取数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.update.failure  |  后端的失败孪生更新数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.update.size  |  后端的失败孪生更新大小  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.update.success  |  后端的成功孪生更新数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  C2DMessagesExpired  |  过期的 C2D 消息数（预览版）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  配置  |  配置指标  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Devices/IotHubs  |  connectedDeviceCount  |  连接设备数（预览）  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.builtIn.events  |  路由：消息传送到消息/事件的次数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.eventHubs  |  路由：消息传送到事件中心的次数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.serviceBusQueues  |  路由：消息传送到服务总线队列的次数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.serviceBusTopics  |  路由：消息传送到服务总线主题的次数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.storage  |  路由：消息传送到存储的次数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.storage.blobs  |  路由：将 Blob 传送到存储的次数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.storage.bytes  |  路由：传送到存储的数据量  |  字节  |  总计 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.latency.storage  |  路由：存储的消息延迟  |  毫秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.dropped  |  路由：遥测消息删除次数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.fallback  |  路由：消息传送到回退路由的次数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.invalid  |  路由：遥测消息不兼容  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.orphaned  |  路由：遥测消息孤立次数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.success  |  路由：遥测消息传送次数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.ingress.success  |  发送的遥测消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.read.failure  |  设备的失败孪生读取数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.read.size  |  设备的孪生读取的响应大小  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.read.success  |  设备的成功孪生读取数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.update.failure  |  设备的失败孪生更新数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.update.size  |  设备的孪生更新的大小  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.update.success  |  设备的成功孪生更新数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  deviceDataUsageV2  |  设备数据用量总计（预览）  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  devices.connectedDevices.allProtocol  |  连接的设备数（已弃用）   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  devices.totalDevices  |  设备总数（已弃用）  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.createTwinUpdateJob.failure  |  孪生更新作业创建失败数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.createTwinUpdateJob.success  |  孪生更新作业创建成功数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  twinQueries.failure  |  失败的孪生查询数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  twinQueries.resultSize  |  孪生查询结果大小  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  twinQueries.success  |  成功的孪生查询数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Insights/Components  |  exceptions/count  |  异常  |  计数  |  计数 | 
...
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportNumOfRecordsExported  |  连续导出 – 导出的记录数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Media/mediaservices/streamingEndpoints  |  请求  |  请求  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Media/mediaservices/streamingEndpoints  |  SuccessE2ELatency  |  成功端到端延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  GCPauseTotalCount  |  GC 暂停计数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  GCPauseTotalTime  |  GC 暂停总时间  |  毫秒  |  总计 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  MaxOldGenMemoryPoolBytes  |  最大可用的旧代数据大小  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  OldGenMemoryPoolBytes  |  旧代数据大小  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  OldGenPromotedBytes  |  提升为旧代数据大小  |  字节  |  最大值 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  ServiceCpuUsagePercentage  |  服务 CPU 使用率百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  ServiceMemoryCommitted  |  分配的服务内存  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  ServiceMemoryMax  |  最大服务内存  |  字节  |  最大值 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  ServiceMemoryUsed  |  已用的服务内存  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  SystemCpuUsagePercentage  |  系统 CPU 使用率百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  TomcatErrorCount  |  Tomcat 全局错误  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  TomcatRequestTotalCount  |  Tomcat 请求总数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  TomcatSessionActiveCurrentCount  |  Tomcat 会话活动计数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  TomcatSessionActiveMaxCount  |  Tomcat 会话最大活动计数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  TomcatSessionAliveMaxTime  |  Tomcat 会话最大活动时间  |  毫秒  |  最大值 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  TomcatSessionCreatedCount  |  Tomcat 创建的会话数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  TomcatSessionExpiredCount  |  Tomcat 过期的会话数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  TomcatSessionRejectedCount  |  Tomcat 拒绝的会话数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Microservices4Spring/appClusters  |  YoungGenPromotedBytes  |  提升为新代数据大小  |  字节  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  CurrentConnections  |  当前连接数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Network/networkWatchers/connectionMonitors  |  AverageRoundtripMs  |  平均值往返时间（毫秒）  |  毫秒  |  平均值 | 
...
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.all  |  安装管理操作数目  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.delete  |  删除安装操作数目  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.get  |  获取安装操作数目  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.patch  |  修补安装操作数目  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.upsert  |  创建或更新安装操作数目  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.create  |  注册创建操作数目  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.delete  |  注册删除操作数目  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.get  |  注册读取操作数目  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.update  |  注册更新操作数目  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  scheduled.pending  |  挂起的已计划通知数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/读取  |  平均值磁盘秒数/读取  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/读取  |  平均值磁盘秒数/读取  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/传输  |  平均值磁盘秒数/传输  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/写入  |  平均值磁盘秒数/写入  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/写入  |  平均值磁盘秒数/写入  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Current Disk Queue Length  |  当前的磁盘队列长度  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  storage  |  已用数据空间  |  字节  |  最大值 | 
...
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  请求  |  请求  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Web/sites  |  句柄数  |  句柄计数  |  计数  |  平均值 | 
...
| **是**  | **是** |  Microsoft.Web/sites  |  PrivateBytes  |  专用字节数  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites  |  请求  |  请求  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  RequestsInApplicationQueue  |  应用程序队列中的请求数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites  |  线程数  |  线程计数  |  计数  |  平均值 | 
...
| **是**  | **是** |  Microsoft.Web/sites/slots  |  句柄数  |  句柄计数  |  计数  |  平均值 | 
...
| **是**  | **是** |  Microsoft.Web/sites/slots  |  PrivateBytes  |  专用字节数  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  请求  |  请求  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  RequestsInApplicationQueue  |  应用程序队列中的请求数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  线程数  |  线程计数  |  计数  |  平均值 | 
