...
ms.author: v-johya
ms.date: 07/17/2020
ms.openlocfilehash: f7e8aba3dba63fe64997ca6dd0e73b3a887abdf0
ms.sourcegitcommit: 2b78a930265d5f0335a55f5d857643d265a0f3ba
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/28/2020
ms.locfileid: "87244808"
---
...
- 要通过 CLI 使用日志查询访问 Azure Monitor 日志数据，请参阅 [CLI Log Analytics 参考](https://docs.microsoft.com/cli/ext/log-analytics/monitor/log-analytics)。
