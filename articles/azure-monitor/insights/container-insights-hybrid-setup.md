...
ms.author: v-johya
ms.date: 05/22/2020
ms.openlocfilehash: de60ae78410d7382ac115fd54fd5f89827125c56
ms.sourcegitcommit: be0a8e909fbce6b1b09699a721268f2fc7eb89de
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/29/2020
ms.locfileid: "84200007"
---
...
* 容器运行时：Docker、Moby 和 CRI 兼容的运行时，例如 CRI-O 和 ContainerD。
...
* 需要成为 **Log Analytics 参与者角色**的成员才能启用容器监视。 若要详细了解如何控制对 Log Analytics 工作区的访问，请参阅[管理对工作区和日志数据的访问](../platform/manage-access.md)。
...
1. 使用以下命令列出你有权访问的所有订阅：
    ...
    ------------------------------------  -----------  ------------------------------------  -------  -----------
    Azure                       AzureCloud   68627f8c-91fO-4905-z48q-b032a81f8vy0  Enabled  True
    ```
...
2. 运行以下命令来安装图表：
    ...
    如果 Log Analytics 工作区位于 Azure 中国版中，请运行以下命令：
...
你可以在 AKS 引擎群集规范 json 文件中指定一个加载项，也称为 API 模型。 在此加载项中，提供存储着所收集监视数据的 Log Analytics 工作区的 base64 编码版 `WorkspaceGUID` 和 `WorkspaceKey`。
