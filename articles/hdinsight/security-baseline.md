...
HDInsight 中使用 Azure Active Directory 域服务的企业安全性套餐配置： https://docs.microsoft.com/azure/hdinsight/domain-joined/apache-domain-joined-configure-using-azure-adds
...
**指导**：使用 Azure 策略“[拒绝]”和“[不存在则部署]”来对 Azure HDInsight 群集和相关资源强制实施安全设置。
...
**指导**：如果使用自定义的 Azure 策略定义，请使用 Azure DevOps 或 Azure Repos 来安全存储和管理代码。
