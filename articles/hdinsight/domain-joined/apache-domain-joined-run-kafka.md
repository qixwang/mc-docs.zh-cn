...
ms.topic: tutorial
ms.date: 05/19/2020
ms.openlocfilehash: 1d54d903775de55db0febd689b8c2b024f6b6a9c
ms.sourcegitcommit: 362814dc7ac5b56cf0237b9016a67c35d8d72c32
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/31/2020
ms.locfileid: "87457500"
---
...
1. 在浏览器中，使用 URL `https://ClusterName.azurehdinsight.cn/Ranger/` 连接到 Ranger 管理用户界面。 请记住将 `ClusterName` 更改为 Kafka 群集的名称。 Ranger 凭据与 Hadoop 集群凭据不同。 若要防止浏览器使用缓存的 Hadoop 凭据，请使用新的 InPrivate 浏览器窗口连接到 Ranger 管理 UI。
