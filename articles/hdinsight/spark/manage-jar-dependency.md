...
* [使用 HDInsight IntelliJ 工具](/hdinsight/hadoop/hdinsight-tools-for-intellij-with-hortonworks-sandbox)

* [在 IntelliJ 中为 Spark 创建 Scala Maven 应用程序](/hdinsight/spark/apache-spark-create-standalone-application)
