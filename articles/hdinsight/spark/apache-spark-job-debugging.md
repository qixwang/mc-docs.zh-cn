...
1. 要启动 Spark History Server，请在“概述”边栏选项卡的“群集仪表板”下单击“Spark History Server”   。
    ...
    ![启动 Spark History Server1](./media/apache-spark-job-debugging/launch-spark-history-server.png "启动 Spark History Server1")
...
2. 随后会看到已列出所有已完成的应用程序。 单击应用程序 ID 可深入到该应用程序以获取更多信息。
    ...
    ![启动 Spark History Server2](./media/apache-spark-job-debugging/view-completed-applications.png "启动 Spark History Server2")
