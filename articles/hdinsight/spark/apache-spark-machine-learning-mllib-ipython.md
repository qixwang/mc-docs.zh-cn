...
ms.date: 06/08/2020
ms.author: v-yiso
ms.openlocfilehash: 89feca6771bb1bbd014d88175e1e97c2996bef0e
ms.sourcegitcommit: 0130a709d934d89db5cccb3b4997b9237b357803
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/29/2020
ms.locfileid: "84186433"
---
...
在此示例中，我们使用 Spark 对食品检测数据 (Food_Inspections1.csv) 进行一些预测分析。 通过[上海市数据门户](https://data.cityofchicago.org/)获取的数据。 此数据集包含在上海执行的食品检验的相关信息，包括被检查的每个食品机构的信息、发现的违规行为（如果有）以及检验结果。 CSV 数据文件在与群集（位于 **/HdiSamples/HdiSamples/FoodInspectionData/Food_Inspections1.csv**）关联的存储帐户中可用。
