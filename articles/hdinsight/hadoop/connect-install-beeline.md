...
ms.date: 07/06/2020
ms.openlocfilehash: e178e947ff60f8612fcf0723292efb065eef0d3e
ms.sourcegitcommit: 3a8a7d65d0791cdb6695fe6c2222a1971a19f745
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/28/2020
ms.locfileid: "85516846"
---
...
1. 在 Web 浏览器中，导航到 `https://CLUSTERNAME.azurehdinsight.cn/#/main/services/HIVE/summary`，其中 `CLUSTERNAME` 是群集的名称。 确保 HiveServer2 正在运行。

1. 使用剪贴板复制 HiveServer2 JDBC URL。

### <a name="over-public-or-private-endpoints"></a>通过公共或专用终结点

使用公共或专用终结点连接到群集时，必须提供群集登录帐户名（默认值为 `admin`）和密码。 例如，使用 Beeline 从客户端系统连接到 `clustername.azurehdinsight.cn` 地址。 此连接通过端口 `443` 建立，并使用 TLS/SSL 进行加密。
