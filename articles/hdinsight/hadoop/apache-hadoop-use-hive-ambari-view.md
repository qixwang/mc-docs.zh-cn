...
ms.date: 10/28/2019
ms.author: v-yiso
ms.openlocfilehash: f5f6fc4fb7b5830d06f9461c30d5227d84408af1
ms.sourcegitcommit: 3de7d92ac955272fd140ec47b3a0a7b1e287ca14
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/12/2020
ms.locfileid: "84723046"
---
...
1. 在 [Azure 门户](https://portal.azure.cn/)中，选择群集。  有关说明，请参阅[列出和显示群集](../hdinsight-administer-use-portal-linux.md)。 群集会在新的门户视图中打开。

1. 从**群集仪表板**中，选择“Ambari 视图”****。 当提示进行身份验证时，请使用在创建群集时所提供的群集登录名（默认为 `admin`）帐户名称和密码。 还可以在浏览器中导航到 `https://CLUSTERNAME.azurehdinsight.cn/#/main/views`，其中 `CLUSTERNAME` 是群集的名称。

3. 在视图列表中，选择“Hive 视图”____。
...
4. 将以下 HiveQL 语句从“查询”____ 选项卡粘贴到工作表中：
