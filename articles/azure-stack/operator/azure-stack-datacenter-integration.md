...
ms.openlocfilehash: da819105bc8b200f9b408c274325ac3a0672e8bd
ms.sourcegitcommit: 134afb420381acd8d6ae56b0eea367e376bae3ef
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/15/2020
ms.locfileid: "83422134"
---
...
需要较高级别的访问权限来排查无法通过警报调解步骤解决的问题时，请联系 Azure 支持部门。 支持人员会提供暂时性的完整管理员访问权限，让你通过某种方法访问系统，以执行更高级的操作。
...
对于单租户 Intranet 和多租户方案，可以通过 [ExpressRoute](/expressroute/expressroute-introduction) 将 Azure Stack Hub 连接到 Azure。 需要通过[连接提供商](/expressroute/expressroute-locations)预配 ExpressRoute 线路。
