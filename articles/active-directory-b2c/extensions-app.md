...
ms.author: v-junlch
ms.subservice: B2C
ms.openlocfilehash: ab853d18910f5cf9154eb0b94dbf524b41351e58
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "77028350"
---
...
1. 浏览到 [https://developer.microsoft.com/zh-cn/graph/graph-explorer-china/](https://developer.microsoft.com/zh-cn/graph/graph-explorer-china/)。
1. 以要还原的已删除应用所在的 Azure AD B2C 目录的全局管理员身份登录到此网站。 此全局管理员必须具有类似于以下形式的电子邮件地址：`username@{yourTenant}.partner.onmschina.cn`。
1. 对 URL `https://graph.chinacloudapi.cn/myorganization/deletedApplications` 发出 HTTP GET，其中 api-version=1.6。 此操作将列出过去 30 天内删除的所有应用程序。
1. 在列表中找到名称以“b2c-extensions-app”开头的应用程序，并复制其 `objectid` 属性值。
1. 对 URL `https://graph.chinacloudapi.cn/myorganization/deletedApplications/{OBJECTID}/restore` 发出 HTTP POST。 将此 URL 的 `{OBJECTID}` 部分替换为之前步骤中的 `objectid`。
