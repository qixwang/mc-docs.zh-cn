...
ms.author: v-junlch
ms.subservice: B2C
ms.openlocfilehash: 8db60d55decb2329b06cf80b7f17eeab1db1a5bd
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "77028321"
---
...
每个使用 Azure AD B2C 的应用都需要在 [Azure 门户](https://portal.azure.cn)的 B2C 目录中注册。 应用注册过程将收集一些值并将其分配给应用：
...
若要深入了解 Azure AD B2C 中使用的不同类型令牌，请参阅 [Azure AD 令牌参考](tokens-overview.md)。

## <a name="protocols"></a>协议
准备好查看一些示例请求时，可以从以下教程中的其中一篇开始。 每篇教程对应于特定的身份验证方案。 如果在确定适当的流时需要帮助，请查看[使用 Azure AD B2C 可以构建的应用类型](application-types.md)。

* [使用 OAuth 2.0 构建移动和本机应用程序](authorization-code-flow.md)
* [使用 OpenID Connect 构建 Web 应用](openid-connect.md)
* [使用 OAuth 2.0 隐式流构建单页应用](implicit-flow-single-page-application.md)
