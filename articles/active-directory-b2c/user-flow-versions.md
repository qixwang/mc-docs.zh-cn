...
ms.author: v-junlch
ms.subservice: B2C
ms.openlocfilehash: 03cc78ac50eba3ebfa4d4da2435b8ca0b9eedafa
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "77028102"
---
# <a name="user-flow-versions-in-azure-active-directory-b2c"></a>Azure Active Directory B2C 中的用户流版本

Azure Active Directory B2C (Azure AD B2C) 中的用户流可帮助设置完全描述客户标识体验的常见[策略](user-flow-overview.md)。 这些体验包括注册、登录、密码重置和配置文件编辑。 在 Azure AD B2C 中，可从推荐用户流和预览用户流的集合中进行选择。
...
>[!IMPORTANT]
> 除非将用户流标识为“建议”  ，否则将其视为处于“预览”  状态。 仅应对生产应用程序使用建议的用户流。
