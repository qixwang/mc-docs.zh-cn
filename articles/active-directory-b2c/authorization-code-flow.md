...
ms.openlocfilehash: 5cf9927c2ee630a363a8bc2937d35eb802836239
ms.sourcegitcommit: dd2bc914f6fc2309f122b1c7109e258ceaa7c868
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/28/2020
ms.locfileid: "87297668"
---
...
Azure AD B2C 扩展了标准 OAuth 2.0 流，使其功能远远超出了简单的身份验证和授权。 它引入了[用户流](user-flow-overview.md)。 借助用户流，可使用 OAuth 2.0 向应用程序添加用户体验，例如注册、登录和配置文件管理。 使用 OAuth 2.0 协议的标识提供者包括 [Azure Active Directory](identity-provider-azure-ad-single-tenant.md)、[QQ](identity-provider-qq.md)、[Wechat](identity-provider-wechat.md) 和 [Weibo](identity-provider-weibo.md)。
