...
| **适用的技术** | SQL Azure |
| **属性**              | SQL 版本 - V12 |
| **参考**              | [使用 Azure Active Directory 身份验证连接到 SQL 数据库](/sql-database/sql-database-aad-authentication) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [什么是 Azure 多重身份验证？](/active-directory/authentication/concept-mfa-howitworks) |
...
| **适用的技术** | 泛型 |
| **属性**              | 环境 - Azure  |
| **参考**              | [Service Fabric 群集安全方案](/service-fabric/service-fabric-cluster-security) |
...
| **适用的技术** | 泛型 |
| **属性**              | 环境 - Azure，环境 - 独立 |
| **参考**              | [Service Fabric 客户端到节点的证书安全性](/service-fabric/service-fabric-cluster-security#_client-to-node-certificate-security)、[使用客户端证书连接到安全群集](/service-fabric/service-fabric-connect-to-secure-cluster) |
...
| **适用的技术** | 泛型 |
| **属性**              | 环境 - Azure |
| **参考**              | [群集安全方案 - 安全建议](/service-fabric/service-fabric-cluster-security#security-recommendations) |
...
| **适用的技术** | 泛型 |
| **属性**              | 环境 - Azure |
| **参考**              | [X.509 证书和 Service Fabric](/service-fabric/service-fabric-cluster-security#x509-certificates-and-service-fabric) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [Azure AD 的身份验证方案](/active-directory/develop/authentication-vs-authorization)、[Azure Active Directory 代码示例](/active-directory/azuread-dev/sample-v1-code)、[Azure Active Directory 开发人员指南](https://docs.azure.cn/active-directory/develop/) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [ADAL](/active-directory/azuread-dev/active-directory-authentication-libraries) |
...
| **参考**              | 不适用，[使用 .NET 的 Azure IoT 中心](/iot-hub/quickstart-send-telemetry-dotnet)、[IoT 中心和 Node JS 入门](/iot-hub/quickstart-send-telemetry-node)、[使用 SAS 和证书保护 IoT](/iot-hub/iot-hub-devguide-security#supported-x509-certificates)、[Git 存储库](https://github.com/Azure/azure-iot-sdks/) |
...
| **参考**              | [Azure IoT 中心安全令牌](/iot-hub/iot-hub-devguide-security#supported-x509-certificates) |
...
| **适用的技术** | 泛型 |
| **属性**              | StorageType - Blob |
| **参考**              | [管理对容器和 Blob 的匿名读取访问](/storage/blobs/storage-manage-access-to-resources?tabs=dotnet)、[共享访问签名，第 1 部分：了解 SAS 模型](/storage/common/storage-sas-overview) |
