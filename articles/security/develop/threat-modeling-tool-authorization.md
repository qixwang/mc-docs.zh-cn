...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [事件中心身份验证和安全模型概述](https://docs.azure.cn/event-hubs/authenticate-shared-access-signature) |
...
| **适用的技术** | 泛型 |
| **属性**              | 环境 - Azure |
| **参考**              | [适用于 Service Fabric 客户端的基于角色的访问控制](https://docs.azure.cn/service-fabric/service-fabric-cluster-security-roles) |
...
| **适用的技术** | 泛型 |
| **属性**              | StorageType - 表 |
| **参考**              | [如何使用 SAS 来委派对 Azure 存储帐户中对象的访问权限](/storage/blobs/security-recommendations#_data-plane-security) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **参考**              | [如何使用基于角色的访问控制 (RBAC) 来保护存储帐户](/storage/blobs/security-recommendations#management-plane-security) |
