---
title: 加密 - Microsoft 威胁建模工具 - Azure | Azure 文档
...
ms.openlocfilehash: 63cd48fba1f12ff8f5c598c0c140eb61c18b0e52
ms.sourcegitcommit: 79c99a9ea013b3c74706a1038a505f4eea2aaac4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/05/2020
ms.locfileid: "84439619"
---
...
## <a name="use-only-approved-symmetric-block-ciphers-and-key-lengths"></a><a id="cipher-length"></a>只使用批准的对称块加密法和密钥长度
...
## <a name="use-approved-block-cipher-modes-and-initialization-vectors-for-symmetric-ciphers"></a><a id="vector-ciphers"></a>为对称加密法使用批准的块加密法模式和初始化向量
...
## <a name="use-approved-asymmetric-algorithms-key-lengths-and-padding"></a><a id="padding"></a>使用批准的非对称算法、密钥长度和填充
...
## <a name="use-approved-random-number-generators"></a><a id="numgen"></a>使用批准的随机数生成器
...
## <a name="do-not-use-symmetric-stream-ciphers"></a><a id="stream-ciphers"></a>不要使用对称流加密法
...
## <a name="use-approved-machmackeyed-hash-algorithms"></a><a id="mac-hash"></a>使用批准的 MAC/HMAC/键控哈希算法
...
## <a name="use-only-approved-cryptographic-hash-functions"></a><a id="hash-functions"></a>只使用批准的加密哈希函数
...
## <a name="use-strong-encryption-algorithms-to-encrypt-data-in-the-database"></a><a id="strong-db"></a>使用强加密算法加密数据库中的数据
...
## <a name="ensure-a-device-management-policy-is-in-place-that-requires-a-use-pin-and-allows-remote-wiping"></a><a id="pin-remote"></a>确保实施要求使用 PIN 并允许远程擦除的设备管理策略
...
## <a name="ensure-that-cryptographically-strong-client-id-client-secret-are-used-in-identity-server"></a><a id="client-server"></a>确保在标识服务器中使用强加密型客户端 ID 和客户端密码
