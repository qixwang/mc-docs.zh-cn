...
使用 `<your_storage_account>` 的存储帐户名称。 对于 <your_storage_account_key>，请使用 [Azure 门户](https://portal.azure.cn)中列出的存储帐户的访问密钥。 有关存储帐户和访问密钥的信息，请参阅[创建存储帐户](../storage/common/storage-create-storage-account.md)。
