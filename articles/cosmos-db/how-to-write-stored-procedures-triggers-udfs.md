...
### <a name="transactions-within-stored-procedures"></a>存储过程中的事务
...
### <a name="bounded-execution-within-stored-procedures"></a>存储过程中的绑定执行
...
<a name="udfs"></a>
## <a name="how-to-write-user-defined-functions"></a>如何编写用户定义的函数
