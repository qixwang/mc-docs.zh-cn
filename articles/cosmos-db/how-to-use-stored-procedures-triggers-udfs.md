...
## <a name="how-to-run-pre-triggers"></a>如何运行前触发器
...
## <a name="how-to-run-post-triggers"></a>如何运行后触发器
...
<a name="udfs"></a>
## <a name="how-to-work-with-user-defined-functions"></a>如何使用用户定义的函数
