                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">中国区 Azure 的操作指南</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul id="get-started1" class="cardsL">
                            <li>
                                <div class="container intro">
                                    <h2 class="likeAnH1">Azure 入门</h2>
                                    <p>使用快速入门、示例和教程探索我们最常用的服务。</p>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>部署基础结构</h3>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/virtual-machines/linux/">Linux 虚拟机</a></li>
                                                    <li><a class="barLink" href="/virtual-machines/windows/">Windows 虚拟机</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/security-center/">Azure 安全中心</a></li>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>混合</h3>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure-stack/">Azure Stack</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="/azure-portal/">
                                                            <img src="https://docs.microsoft.com/media/logos/logo_azure.svg" alt=""> Azure 门户</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                ...
                <ul id="products">
                            ...
                            <li>
                                <div class="group">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/hdinsight/spark/apache-spark-overview">
                                                <img src="media/index/hdinsight.svg" alt="" />
                                                <p>Apache Spark for Azure HDInsight</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/hdinsight/storm/apache-storm-overview">
                                                <img src="media/index/hdinsight.svg" alt="" />
                                                <p>Apache Storm for HDInsight</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure-monitor/overview">
                                ...
                                <div class="group">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview?toc=%2Fvirtual-machines%2Fwindows%2Ftoc.json">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>虚拟机上的 SQL Server</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>容器</h3>
                            ...
                            <li>
                                <div class="group">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/media-services/media-services-encode-asset">
                                                <img src="media/index/Media-encoding.svg" alt="" />
                                                <p>编码</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/media-services/media-services-manage-channels-overview">
                                                <img src="media/index/media-ondemand.svg" alt="" />
                                                <p>实时和按需流式处理</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/media-services/media-services-playback-content-with-existing-players">
                                                <img src="media/index/media-player.svg" alt="" />
                                                <p>Azure Media Player</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/media-services/media-services-content-protection-overview">
                                                <img src="media/index/media-protection.svg" alt="" />
                                                <p>内容保护</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/media-services/media-services-analytics-overview">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>虚拟机上的 SQL Server</h3>
                                                    <p>在云中托管企业 SQL Server 应用</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        ...
                        <ul id="databases" class="cardsA">
                            ...
                            <li>
                                <a href="/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview?toc=%2Fazure%2Fvirtual-machines%2Fwindows%2Ftoc.json">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>适用于应用开发人员的托管 MariaDB 数据库服务</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure 门户</h3>
                                                    <p>在单个统一的控制台中生成、管理和监视所有 Azure 产品</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>内容保护</h3>
                                                    <p>使用 AES、PlayReady、Widevine 和 Fairplay 安全地分发内容</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Stack</h3>
                                                    <p>在本地扩展 Azure 服务和功能，以便生成和部署跨云边界的混合云和边缘应用程序</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Stack 操作员</h3>
                                                    <p>了解如何管理 Azure Stack 集成系统基础结构以及如何提供服务</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a href="/azure-stack/user">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure Stack 用户</h3>
                                                <p>使用服务并为 Azure Stack 构建应用程序</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
面向 Python 开发人员的 Azure </h3>
                                                <p>
                                                    <a target="_blank" href="https://docs.microsoft.com/python/azure">入门</a>
                                                </p>
                                                <p>
                                                    <a target="_blank" href="https://docs.microsoft.com/python/api/overview/azure/">API 参考</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
面向 Go 开发人员的 Azure </h3>
                                                <p>
                                                    <a target="_blank" href="https://docs.microsoft.com/go/azure/">入门</a>
                                                </p>
                                                <p>
                                                    <a href="https://godoc.org/github.com/Azure/azure-sdk-for-go">API 参考</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure REST API </h3>
                                                <p>
                                                    <a target="_blank" href="https://docs.microsoft.com/rest/api">API 参考</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Azure CLI </h3>
                                                ...
                                                <p>
                                                    <a href="/cli/reference-index">参考</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-azurestorage">存储</a>
                                                </p>
                                                <p>
...
Docker </h3>
                                                ...
                                                <p>
                                                    <a href="https://www.visualstudio.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2017">适用于 Visual Studio 的下载项</a>
                                                </p>
                                                <p>
...
Azure 体系结构中心包含用于在 Azure 上构建端到端解决方案的指南。 此处提供了参考体系结构、最佳做法、设计模式、方案指南和参考实现。
                            ...
                            <li>
                                <a target="_blank" href="https://docs.microsoft.com/azure/architecture/reference-architectures/">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                ...
                                                <div class="cardText">
                                                    <h3>参考体系结构</h3>
                                                    <p>适用于云的一组建议的体系结构。 每个体系结构都包括最佳做法、规范步骤和可部署的解决方案。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <a target="_blank" href="https://docs.microsoft.com/azure/architecture/patterns/">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
