...
ms.date: 05/15/2020
ms.author: v-johya
ms.openlocfilehash: 742bab7bbc430859551262bb7ea32ade8679c5ca
ms.sourcegitcommit: 08b42258a48d96d754244064d065e4d5703f1cfb
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/18/2020
ms.locfileid: "83445255"
---
...
> [!NOTE]
> 从策略中彻底删除卷时请谨慎。  如果再次添加该卷，该卷将被视为新卷。 下一次计划备份将执行初始备份（完整备份），而不是增量备份。 如果以后需要临时删除和添加项，我们建议使用“排除设置”而不是“删除项”，以确保执行增量备份而不是完整备份。 
...
- **停止保护并保留备份数据**。
  - 此选项会停止将来所有备份作业的保护。
  - Azure 备份服务将无限期保留所有现有恢复点。 在恢复保护之前，不会检查恢复点是否已过期。
  - 可以还原尚未过期的恢复点的备份数据。
