...
ms.date: 05/15/2020
ms.author: v-johya
ms.openlocfilehash: 02284c2bfaf322081fed09d2af9af4183420c8ab
ms.sourcegitcommit: 08b42258a48d96d754244064d065e4d5703f1cfb
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/18/2020
ms.locfileid: "83445285"
---
...
Azure 备份还提供了内置的 Azure 策略，这些策略会自动为给定范围内的所有保管库配置诊断设置。 若要了解如何使用此策略，请参阅[大规模配置保管库诊断设置](/backup/azure-policy-configure-diagnostics)。
...
* 此外，将诊断数据发送到存储帐户或 Log Analytics 工作区的 V1 架构也即将弃用。 如果你编写了任何基于 V1 架构的自定义查询或自动化，建议你更新这些查询以使用当前支持的 V2 架构。
