...
- 实现并促进遵从合规标准，但不能保证合规性。 有关支持标准符合性的 Azure 程序的详细信息，请参阅 [Azure 信任中心](https://www.azure.cn/support/trust-center/compliance/)，可以从中找到 Azure SQL 符合性认证的最新列表。
...
- 使用 [Azure 门户](https://portal.azure.cn)。  打开相关数据库。 在数据库的“审核”页的顶部，选择“查看审核日志” 。
