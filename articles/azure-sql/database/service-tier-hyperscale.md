...
可以使用 [Azure 门户](https://portal.azure.cn)、[T-SQL](https://docs.microsoft.com/sql/t-sql/statements/create-database-transact-sql?view=azuresqldb-current)、[PowerShell](https://docs.microsoft.com/powershell/module/azurerm.sql/new-azurermsqldatabase) 或 [CLI](/cli/sql/db#az-sql-db-create) 创建超大规模数据库。 仅可通过[基于 vCore 的购买模型](service-tiers-vcore.md)使用超大规模数据库。
...
2. 请遵照有关从自动备份还原 Azure SQL 数据库中数据库的页面上的[异地还原](/sql-database/sql-database-recovery-using-backups#geo-restore)主题中的说明操作。
