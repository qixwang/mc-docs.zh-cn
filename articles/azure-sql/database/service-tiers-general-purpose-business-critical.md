...
| | SQL 托管实例 | 4、8、16、24、32、40、64、80 个 vCore | 空值 | 4、8、16、24 个 Vcore |
...
| | SQL 托管实例  | [每个 vCore 24 GB](../managed-instance/resource-limits.md#service-tier-characteristics) | 空值 | 最大 2 TB - [受存储大小限制](../managed-instance/resource-limits.md#service-tier-characteristics) |
