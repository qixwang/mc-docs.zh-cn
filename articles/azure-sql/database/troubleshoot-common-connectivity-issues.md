...
连接到你的数据库所需的连接字符串与连接到 SQL Server 所需的字符串稍有不同。 可以通过 [Azure 门户](https://portal.azure.cn/)复制数据库的连接字符串。
...
必须配置 SQL 数据库，使其接受来自托管你的客户端程序的计算机 IP 地址的通信。 若要设置此配置，可以通过 [Azure 门户](https://portal.azure.cn/)编辑防火墙设置。
