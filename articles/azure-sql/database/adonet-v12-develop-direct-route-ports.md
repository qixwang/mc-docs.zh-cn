...
* 在 Azure VM 上， **高级安全 Windows 防火墙** 控制端口设置。
  ...
  * 可以使用[防火墙的用户界面](https://docs.microsoft.com/sql/sql-server/install/configure-the-windows-firewall-to-allow-sql-server-access)为指定 **TCP** 协议以及语法类似于 **11000-11999** 的端口范围添加规则。
