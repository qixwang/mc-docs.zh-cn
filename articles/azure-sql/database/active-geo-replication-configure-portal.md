...
本文说明如何使用 [Azure 门户](https://portal.azure.cn)为 [Azure SQL 数据库配置活动异地复制](active-geo-replication-overview.md#active-geo-replication-terminology-and-capabilities)，以及如何启动故障转移。
