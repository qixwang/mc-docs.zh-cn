...
![配置现有 VM 的 SQL AKV 集成](./media/azure-key-vault-integration-configure/azure-sql-rm-akv-configuration.png)
...
<!-- Update_Description: new article about azure key vault integration configure -->
<!--NEW.date: 07/06/2020-->