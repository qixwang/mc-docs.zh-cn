...
![为现有 VM 配置 SQL 自动备份](./media/automated-backup/sql-server-configuration-edit.png)
...
<!-- Update_Description: new article about automated backup -->
<!--NEW.date: 07/06/2020-->