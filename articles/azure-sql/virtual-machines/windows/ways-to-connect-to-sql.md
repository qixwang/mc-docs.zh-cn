...
> [!NOTE]
> 在 VM 上通过 Internet 查询 SQL Server 时，Azure 数据中心的所有传出数据都将服从常规[出站数据传输的定价](https://www.azure.cn/pricing/details/data-transfer/)。
...
<!-- Update_Description: new article about ways to connect to sql -->
<!--NEW.date: 07/06/2020-->