...
<!--CORRECT ON FROM availability-group-azure-marketplace-template-configure.md TO availability-group-quickstart-template-configure.md-->
<!--Not Avaiablle on [Microsoft template](availability-group-quickstart-template-configure.md)-->
<!--Not Avaiablle on You can use the [Microsoft template](availability-group-quickstart-template-configure.md) to automatically create the availability group in Azure Resource Manager. This template automatically creates the availability group, including the internal load balancer for you. If you prefer,-->
...
<!--Not Available on  If the virtual machines are in an availability zone, a standard load balancer is required.-->
