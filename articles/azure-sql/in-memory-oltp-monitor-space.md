...
ms.date: 07/13/2020
ms.openlocfilehash: a975910b20b276e027d8e5804ebef464758a08e3
ms.sourcegitcommit: fa26665aab1899e35ef7b93ddc3e1631c009dd04
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/10/2020
ms.locfileid: "86227186"
---
...
估计内存优化表的内存要求，如同在 Azure SQL 数据库和 Azure SQL 托管实例中估计 SQL Server 的内存要求一样。 需要几分钟时间来查看[估计内存要求](https://docs.microsoft.com/sql/relational-databases/in-memory-oltp/estimate-memory-requirements-for-memory-optimized-tables)。
...
可以在 [Azure 门户](https://portal.azure.cn/)中，通过计算大小的存储上限百分比来监视内存中存储用量： 
