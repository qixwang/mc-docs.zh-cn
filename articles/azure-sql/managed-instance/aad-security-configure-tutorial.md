...
ms.date: 07/13/2020
ms.openlocfilehash: a348898cb794fa6c442e44b8e2d503e04e79f375
ms.sourcegitcommit: fa26665aab1899e35ef7b93ddc3e1631c009dd04
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/10/2020
ms.locfileid: "86227261"
---
...
有关详细信息，请参阅 [CREATE LOGIN](https://docs.microsoft.com/sql/t-sql/statements/create-login-transact-sql?view=azuresqldb-mi-current)。
...
1. 在查询窗口中，使用以下语法为另一个 Azure AD 帐户创建登录名：
    ...
    此示例为 Azure AD 用户 bob@aadsqlmi.net 创建登录名。该用户的 aadsqlmi.net 域已与 Azure AD aadsqlmi.partner.onmschina.cn 相联合。
...
- 支持 Azure AD 服务器主体（登录名）使用 [sqlcmd 实用工具](https://docs.microsoft.com/sql/tools/sqlcmd-utility)和 [SQL Server Management Studio](https://docs.microsoft.com/sql/ssms/download-sql-server-management-studio-ssms) 工具。
