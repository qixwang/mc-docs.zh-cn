...
ms.topic: conceptual
ms.date: 06/12/2020
ms.openlocfilehash: 4907f4d5d52bc4748ce3092e86ba67ac73881270
ms.sourcegitcommit: 3de7d92ac955272fd140ec47b3a0a7b1e287ca14
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/12/2020
ms.locfileid: "84723658"
---
...
4. 向下滚动到 JSON 的“属性”部分，其中提供导致失败操作的错误的详细信息****。 在本示例中，失败的原因在于超出范围的纬度值的运行时错误。 流分析作业处理的数据不一致会导致数据错误。 你可以了解不同的[输入和输出数据错误及其发生原因](/stream-analytics/data-errors)。
...
4. 流分析提供预定义的查询，使你可以轻松搜索感兴趣的日志。 这 3 个类别是**常规**、**输入数据错误**和**输出数据错误**。 例如，若要查看过去 7 天内所有作业错误的摘要，可以选择适当预定义查询的“运行”****。 
   ...
   ![“监视”下的“资源日志”](./media/stream-analytics-job-diagnostic-logs/logs-categories.png)
...
作业处理数据期间出现的任何错误都在此日志类别中。 这些日志通常创建于读取数据、序列化和写入操作期间。 这些日志不包括连接错误。 连接错误被视为泛型事件。 你可以详细了解各种[输入和输出数据错误](/stream-analytics/data-errors)的原因。
...
* [流分析数据错误](/stream-analytics/data-errors)
