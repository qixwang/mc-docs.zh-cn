...
此查询隔 5 秒就会生成事件，并输出上次收到的最后一个事件。 **HOPPINGWINDOW** 持续时间确定查询在查找最新事件时回溯多久。
...
**COUNT(DISTINCT Time)** 返回时间范围内“时间”列中的非重复值数目。 然后，可以使用第一个步骤的输出并丢弃重复值，来按设备计算平均值。
...
| 1 | 2017-01-26T00:00:55.0000000Z | 2017-01-26T00:01:15.0000000Z | 20 个 |
