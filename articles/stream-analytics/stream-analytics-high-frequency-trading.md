...
![线性回归数学公式](./media/stream-analytics-high-frequency-trading/linear-regression-formula.png)
...
![交易 Power BI 图表视觉对象](./media/stream-analytics-high-frequency-trading/trades-power-bi-chart.png)
