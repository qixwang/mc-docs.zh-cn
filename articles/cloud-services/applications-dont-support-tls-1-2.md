...
> [!NOTE]
> 来宾 OS 系列 6 版本通过显式禁用 TLS 1.0 和 1.1 并定义一组特定的密码套件来强制执行 TLS 1.2。有关来宾 OS 系列的更多信息，请参阅[来宾 OS 发布新闻](/cloud-services/cloud-services-guestos-update-matrix#family-6-releases)
...
有关详细信息，请参阅[在 Azure 中准备 TLS 1.2](https://azure.microsoft.com/updates/azuretls12/)
