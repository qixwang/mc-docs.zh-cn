...
此处显示了 [ServiceDefinition.csdef] 文件的相关节，其中包括将 [executionContext](https://docs.microsoft.com/previous-versions/azure/reference/gg557552(v=azure.100)#task) 属性设为 `elevated` 以为 AppCmd.exe  提供足够的权限来更改 *Web.config* 文件中的设置：
