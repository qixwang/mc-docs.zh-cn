...
[How to: Determine Which .NET Framework Versions Are Installed]: https://docs.microsoft.com/dotnet/framework/migration-guide/how-to-determine-which-versions-are-installed
[Installing the .NET Framework]: https://docs.microsoft.com/dotnet/framework/install/guide-for-developers
[Troubleshooting .NET Framework Installations]: https://docs.microsoft.com/dotnet/framework/install/troubleshoot-blocked-installations-and-uninstallations
