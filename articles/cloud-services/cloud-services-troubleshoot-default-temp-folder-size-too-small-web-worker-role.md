...
ms.date: 05/25/2020
ms.author: v-junlch
ms.openlocfilehash: e5abd9159b17fd4554fcb682ca2e1580b2f1ef77
ms.sourcegitcommit: 7429daf26cff014b040f69cdae75bdeaea4f4e93
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/27/2020
ms.locfileid: "83991595"
---
...
* 配置本地存储资源，直接对其进行访问而不使用 TEMP 或 TMP。 若要通过应用程序内运行的代码访问本地存储资源，请调用 [RoleEnvironment.GetLocalResource](https://docs.microsoft.com/previous-versions/azure/reference/ee772845(v=azure.100)) 方法。
* 配置本地存储资源，将 TEMP 和 TMP 目录指向本地存储资源的路径。 应在 [RoleEntryPoint.OnStart](https://docs.microsoft.com/previous-versions/azure/reference/ee772851(v=azure.100)) 方法中进行这种修改。
