...
:::image type="content" source="./media/network-watcher-analyze-nsg-flow-logs-graylog/workflow.png" alt-text="Graylog 工作流":::
...
- Java SE 8 或更高版本 - [Azul Azure JDK 文档](https://docs.azure.cn/java/java-supported-jdk-runtime?view=azure-java-stable)
...
2. 若要导航到配置页，请在顶部导航栏的右侧选择“系统”下拉菜单，并单击“输入”。 
    ...
    :::image type="content" source="./media/network-watcher-analyze-nsg-flow-logs-graylog/getting-started.png" alt-text="入门":::
...
3. 若要启动新输入，请在“选择输入”下拉列表中选择“GELF UDP”，并填写表单。 GELF 是“Graylog 扩展日志格式”(Graylog Extended Log Format) 的缩写。 GELF 格式由 Graylog 开发。 若要详细了解此格式的优点，请参阅 Graylog [文档](https://docs.graylog.org/en/2.2/pages/gelf.html)。
    ...
    :::image type="content" source="./media/network-watcher-analyze-nsg-flow-logs-graylog/local-inputs.png" alt-text="显示包含所启动的输入的“本地输入”部分的屏幕截图。":::
...
3. 选择要从中进行可视化的任何所需参数（本示例选择了 IP 源）。 若要显示可能的小组件列表，请单击字段左侧的蓝色下拉箭头，并选择“快速值”生成小组件。 应会看到下图所示的内容：
    ...
    :::image type="content" source="./media/network-watcher-analyze-nsg-flow-logs-graylog/srcip.png" alt-text="源 IP":::
...
5. 导航回到仪表板可以看到刚刚添加的小组件。
    ...
    :::image type="content" source="./media/network-watcher-analyze-nsg-flow-logs-graylog/flowlogs-dashboard.png" alt-text="流日志仪表板":::
