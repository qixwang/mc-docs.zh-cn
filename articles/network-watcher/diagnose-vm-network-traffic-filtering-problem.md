...
ms.author: v-yeche
ms.custom: mvc
ms.openlocfilehash: 0fc7e0b333004716930befd5033b5b0be689036e
ms.sourcegitcommit: a04b0b1009b0c62f2deb7c7acee75a1304d98f87
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/22/2020
ms.locfileid: "83796839"
---
...
2. 请在“中国东部 2”区域启用网络观察程序，因为那是在前面的步骤中将 VM 部署到其中的区域。 选择“区域”，以便将其展开，然后选择“中国东部”右侧的“...”，如下图所示：  
...
在本快速入门中，你已创建 VM 并对入站和出站网络流量筛选器进行诊断。 你已了解了如何通过网络安全组规则来允许或拒绝出入 VM 的流量。 请详细了解[安全规则](../virtual-network/security-overview.md?toc=/network-watcher/toc.json)以及如何[创建安全规则](../virtual-network/manage-network-security-group.md?toc=/network-watcher/toc.json#create-a-security-rule)。
...
<!-- Update_Description: new articles on network watcher diagnose vm network traffic filtering problem -->
<!--ms.date: 07/02/2018-->