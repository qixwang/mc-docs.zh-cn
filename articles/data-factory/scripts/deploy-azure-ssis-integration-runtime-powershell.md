...
| [Set-AzDataFactoryV2IntegrationRuntime](https://docs.microsoft.com/powershell/module/az.datafactory/set-Azdatafactoryv2integrationruntime) | 创建可在云中运行 SSIS 程序包的 Azure-SSIS 集成运行时 |
| [Start-AzDataFactoryV2IntegrationRuntime](https://docs.microsoft.com/powershell/module/az.datafactory/start-Azdatafactoryv2integrationruntime) | 启动 Azure-SSIS 集成运行时。 |
| [Get-AzDataFactoryV2IntegrationRuntime](https://docs.microsoft.com/powershell/module/az.datafactory/get-Azdatafactoryv2integrationruntime) | 获取有关 Azure-SSIS 集成运行时的信息。 |
