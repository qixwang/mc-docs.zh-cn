...
ms.date: 06/04/2020
ms.author: v-johya
ms.openlocfilehash: 23389ef05861d156cf0f15c91a111215156d3ece
ms.sourcegitcommit: 5ae04a3b8e025986a3a257a6ed251b575dbf60a1
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/05/2020
ms.locfileid: "84440542"
---
...
-   [高级策略](api-management-advanced-policies.md#AdvancedPolicies)  
    ...
    -   [跟踪](api-management-advanced-policies.md#Trace) - 将自定义跟踪添加到 [API 检查器](https://docs.azure.cn/api-management/api-management-howto-api-inspector)输出、Application Insights 遥测和资源日志。  
...
-   [身份验证策略](api-management-authentication-policies.md#AuthenticationPolicies)  
    ...
    -   [使用托管标识进行身份验证](api-management-authentication-policies.md#ManagedIdentity) - 使用[托管标识](/active-directory/managed-identities-azure-resources/overview)向后端服务进行身份验证。  
