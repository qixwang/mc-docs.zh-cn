...
> [!NOTE]
> 在不同的云类型之间迁移时，备份和还原无效。 因此，需要[以模板形式](/azure-resource-manager/manage-resource-groups-portal#export-resource-groups-to-templates)导出资源。 然后，改编目标 Azure 区域的已导出模板并重新创建资源。 
