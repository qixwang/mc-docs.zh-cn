...
## <a name="why-use-bgp"></a><a name="why"></a>为什么使用 BGP？
...
### <a name="support-automatic-and-flexible-prefix-updates"></a><a name="prefix"></a>支持自动和灵活的前缀更新
...
### <a name="support-multiple-tunnels-between-a-vnet-and-an-on-premises-site-with-automatic-failover-based-on-bgp"></a><a name="multitunnel"></a>支持 VNet 与本地站点之间的多个隧道基于 BGP 自动进行故障转移
...
### <a name="support-transit-routing-between-your-on-premises-networks-and-multiple-azure-vnets"></a><a name="transitrouting"></a>支持本地网络与多个 Azure VNet 之间的传输路由
...
## <a name="bgp-faq"></a><a name="faq"></a>BGP 常见问题解答
