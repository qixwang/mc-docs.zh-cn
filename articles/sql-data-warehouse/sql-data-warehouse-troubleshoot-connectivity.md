...
否则，请与 IT 管理员联系，验证该维护是否为计划的事件。 若要恢复 SQL 数据仓库，请按[此处](/sql-data-warehouse/pause-and-resume-compute-portal#resume-compute)概述的步骤操作。
...
如果收到 40914 和 40615 错误，请参阅[此处的错误说明和解决方法](/sql-database/sql-database-vnet-service-endpoint-rule-overview?toc=/azure/sql-data-warehouse/toc.json#errors-40914-and-40615)。
...
请进行检查，确保正确设置了连接字符串。  下面是一些示例。  可在[此处](/sql-data-warehouse/sql-data-warehouse-connection-strings)找到有关连接字符串的其他信息。
...
对于 40914 和 40615 错误，请参阅[此处的错误说明和解决方法](/sql-database/sql-database-vnet-service-endpoint-rule-overview?toc=/sql-data-warehouse/toc.json#errors-40914-and-40615)。
