...
* [CREATE WORKLOAD CLASSIFIER](https://docs.microsoft.com/sql/t-sql/statements/create-workload-classifier-transact-sql)
...
* [DROP WORKLOAD CLASSIFIER](https://docs.microsoft.com/sql/t-sql/statements/drop-workload-classifier-transact-sql)
