...
请注意，SQL 数据仓库当前不支持 [@@NESTLEVEL](https://docs.microsoft.com/sql/t-sql/functions/nestlevel-transact-sql)。 需要跟踪嵌套级别。 不太可能超过 8 个嵌套级别的限制，但如果超过了，则需要重新修改代码，以使它符合限制内的嵌套级别。
