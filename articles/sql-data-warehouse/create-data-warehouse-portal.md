...
如果没有 Azure 订阅，可在开始前创建一个 [1 元试用](https://www.azure.cn/pricing/1rmb-trial/)帐户。
...
4. 若要删除已创建的 SQL Server，请单击上图中的“mynewserver-20181129.database.chinacloudapi.cn”  ，然后单击“删除”  。 请谨慎执行此删除操作，因为删除服务器的同时也会删除分配给该服务器的所有数据库。
