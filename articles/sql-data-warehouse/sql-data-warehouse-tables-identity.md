...
- [IDENTITY()](https://docs.microsoft.com/sql/t-sql/functions/identity-function-transact-sql)
- [@@IDENTITY](https://docs.microsoft.com/sql/t-sql/functions/identity-transact-sql)
- [SCOPE_IDENTITY](https://docs.microsoft.com/sql/t-sql/functions/scope-identity-transact-sql)
- [IDENT_CURRENT](https://docs.microsoft.com/sql/t-sql/functions/ident-current-transact-sql)
- [IDENT_INCR](https://docs.microsoft.com/sql/t-sql/functions/ident-incr-transact-sql)
- [IDENT_SEED](https://docs.microsoft.com/sql/t-sql/functions/ident-seed-transact-sql)
...
- [表概述](/sql-data-warehouse/sql-data-warehouse-tables-overview)
- [CREATE TABLE (Transact-SQL) IDENTITY (Property)](https://docs.microsoft.com/sql/t-sql/statements/create-table-transact-sql-identity-property?view=azure-sqldw-latest)
- [DBCC CHECKINDENT](https://docs.microsoft.com/sql/t-sql/database-console-commands/dbcc-checkident-transact-sql)
