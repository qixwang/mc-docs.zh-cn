...
了解使用 [Azure Batch Node.js SDK](https://docs.microsoft.com/javascript/api/overview/azure/batch) 在 Node.js 中生成批处理客户端的基础知识。 我们采用分步方式来了解一个批处理应用程序的方案，并通过 Node.js 客户端设置该方案。  
...
- 请查看 [Batch Node.js reference](https://docs.microsoft.com/javascript/api/overview/azure/batch)（批处理 Node.js 参考），了解批处理 API。
