...
ms.openlocfilehash: 625e80f9421e284f90744abfa4a835c37be777f6
ms.sourcegitcommit: cbaa1aef101f67bd094f6ad0b4be274bbc2d2537
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/28/2020
ms.locfileid: "84126671"
---
...
虚拟机是用于 Batch 处理的最重要资源。 Batch 中的 VM 使用成本是根据类型、数量和使用持续时间计算的。 VM 计费选项包括[预付费](https://wd.azure.cn/pricing/pia-waiting-list/?form-type=identityauth)（提前支付）。 这两个支付选项根据计算工作负荷而各有优势，这两种支付模式将对帐单产生不同的影响。
