...
ms.author: v-lingwu
ms.topic: conceptual
ms.openlocfilehash: e9364bb76e7b43fa6de88ee6018f506c4df48ed2
ms.sourcegitcommit: 1fbdefdace8a1d3412900c6c3f89678d8a9b29bc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/07/2020
ms.locfileid: "82886888"
---
...
渲染管理软件原生支持 Azure，或者，我们可以提供用于添加 Azure 支持的插件。 有关支持的渲染管理器和功能的详细信息，请参阅有关[使用渲染管理器](/batch/batch-rendering-render-managers)的文章。
...
- [使用 Batch Explorer 渲染 Blender 场景](/batch/tutorial-rendering-batchexplorer-blender)
- [使用 Batch CLI 渲染 Autodesk 3ds Max 场景](/batch/tutorial-rendering-cli)

## <a name="next-steps"></a>后续步骤

在[此文](/batch/batch-rendering-applications)中查看 Azure 市场 VM 映像包含的渲染应用程序和版本列表。
