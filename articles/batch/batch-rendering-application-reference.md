...
可通过创建 Batch 作业和任务来使用渲染应用程序。 任务命令行属性指定相应的命令行和参数。  创建作业任务的最简单方法是使用[此文](/batch/batch-rendering-using#using-batch-explorer)中所述的 Batch Explorer 模板。  可以查看这些模板，并根据需要修改创建的版本。
