...
## <a name="use-azure-ad-with-batch-management-net"></a>将 Azure AD 和 Batch Management .NET 配合使用<a name="azure-active-directory"></a>
...
## <a name="sample-project-on-github"></a>GitHub 上的示例项目 <a name="sample"></a>
