...
ms.custom: seodec18
ms.openlocfilehash: 0819bf39012a3a5ec9255e836c6a97b1044d533f
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "79452537"
---
...
- Azure CLI 2.0.56 或更高版本。 有关安装 Azure CLI 的最新版本的说明，请参阅[安装 Azure CLI](/cli/install-azure-cli)。 
- Azure PowerShell 1.1.0 或更高版本。 从 [Azure 下载 - 命令行工具](/downloads/)在 Windows 计算机上下载 Azure PowerShell 的最新版本。 
...
az storage account create -n $storagename -g gridResourceGroup -l chinaeast --sku Standard_LRS
