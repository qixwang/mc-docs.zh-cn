...
```json
{
  "endpoint": "https://<my-domain-name>.chinaeast-1.eventgrid.azure.net/api/events",
...
可通过[角色分配](/role-based-access-control/role-assignments-cli)来管理对主题的访问。 角色分配使用基于角色的访问控制来限制对 Azure 资源的操作，仅允许经授权用户在特定范围内执行操作。
