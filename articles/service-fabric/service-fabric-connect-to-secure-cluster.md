...
若要指定证书、密钥对，请使用 `--cert` 和 `--key` 参数指定每个相应文件的文件路径。
...
有关 AAD 令牌获取的详细信息，请参阅 [Microsoft.IdentityModel.Clients.ActiveDirectory](https://msdn.microsoft.com/library/microsoft.identitymodel.clients.activedirectory.aspx)。
...
### <a name="connect-to-a-secure-cluster-without-prior-metadata-knowledge-using-azure-active-directory"></a>无需事先了解元数据，即可使用 Azure Active Directory 连接到安全群集
