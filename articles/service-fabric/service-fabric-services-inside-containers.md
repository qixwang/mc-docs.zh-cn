...
9. 有关配置容器隔离模式，请参阅[配置隔离模式]( https://docs.azure.cn/service-fabric/service-fabric-get-started-containers#configure-isolation-mode)。 Windows 支持容器的两种隔离模式：进程和 Hyper-V。 以下代码片段展示了如何在应用程序清单文件中指定隔离模式。
