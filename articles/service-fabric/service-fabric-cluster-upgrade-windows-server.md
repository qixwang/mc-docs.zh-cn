...
如果群集节点已与[下载中心](https://download.microsoft.com)建立 Internet 连接，请使用以下步骤将群集升级到支持的版本。

对于已连接到[下载中心](https://download.microsoft.com)的群集，Azure 会定期检查是否有新的 Service Fabric 版本可用。
