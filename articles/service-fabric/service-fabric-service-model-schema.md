...
ms.date: 02/24/2020
ms.author: v-yeche
ms.openlocfilehash: 712b757bb8cc235cf31cabb8c425f46094348e8f
ms.sourcegitcommit: afe972418a883551e36ede8deae32ba6528fb8dc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/21/2020
ms.locfileid: "77540012"
---
...
本文阐述随 Service Fabric SDK 一起安装的 ServiceFabricServiceModel.xsd 架构文件。  默认情况下，架构文件将安装到 *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*。
...
def writeOverviewFile(filename, namedElements, namedComplexTypes, namedElementGroups, namedAttributeGroups, namedSimpleTypes , NSMAP):
    ...
    with open(filename,'w') as file: 
        ...
        # Write header info
        file.write('---\n')
        file.write('title: Azure Service Fabric service model XML schema descriptions | Azure')
...
def writeElementGroupsFile(filename, namedElementGroups):
    ...
    with open(filename,'w') as file:
        ...
        # Write header info
        file.write('---\n')
        file.write('title: Azure Service Fabric service model XML schema element groups | Azure\n')
...
def writeElementsFile(filename, namedElements):
    ...
    with open(filename,'w') as file:
        ...
        # Write header info
        file.write('---\n')
        file.write('title: Azure Service Fabric service model XML schema elements | Azure')
...
def writeComplexTypesFile(filename, namedComplexTypes):
    ...
    with open(filename,'w') as file:  
        ...
        # Write header info
        file.write('---\n')
        file.write('title: Azure Service Fabric service model XML schema complex types | Azure\n')
...
def writeAttributesFile(filename, namedAttributeGroups):
    ...
    with open(filename,'w') as file:
        ...
        # Write header info
        file.write('---\n')
        file.write('title: Azure Service Fabric service model XML schema attribute groups | Azure\n')
...
def writeSimpleTypesFile(filename, namedSimpleTypes):
    ...
    with open(filename,'w') as file:
        ...
        # Write header info
        file.write('---\n')
        file.write('title: Azure Service Fabric service model XML schema simple types | Azure\n')
