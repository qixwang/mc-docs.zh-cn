...
### <a name="cloud-services"></a>云服务
云服务中的启动入口点是在 ServiceDefinition.csdef 中针对每个角色配置的。 
...
阅读有关 Service Fabric Reliable Services 的详细信息以及云服务与 Service Fabric 应用程序体系结构之间的根本差异，以了解如何利用 Service Fabric 的完整功能集。
