...
ms.date: 04/13/2020
ms.author: v-yeche
ms.openlocfilehash: 20d2176508ecc6d2c5c90143036856ca8cd7fc2c
ms.sourcegitcommit: 564739de7e63e19a172122856ebf1f2f7fb4bd2e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/23/2020
ms.locfileid: "82093228"
---
...
> [!NOTE]
> 在缩减方案中，除非节点类型具有金级或银级[持续性级别][durability]，否则需要使用相应节点名称来调用 [Remove-ServiceFabricNodeState cmdlet](https://docs.microsoft.com/powershell/module/servicefabric/remove-servicefabricnodestate)。 对于铜级持续性，不建议一次缩减多个节点。
> 
> 
...
> [!NOTE]
> 添加 VM 需要时间，请不要期待马上就有结果。 因此请提前规划增加容量的时间，在副本/服务实例可以使用 VM 容量之前有超过 10 分钟的时间让一切就绪。
> 
...
Service Fabric 系统服务在群集中以主节点类型运行。 缩小主节点类型时，切勿在减小实例数时使其小于[可靠性层](service-fabric-cluster-capacity.md)保证的数目。 
