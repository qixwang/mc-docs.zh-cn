...
ms.author: v-yeche
ms.custom: sfrev
ms.openlocfilehash: 19c93fa2eddf1244848d541e98e23f9fb7bd0b4c
ms.sourcegitcommit: afe972418a883551e36ede8deae32ba6528fb8dc
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/21/2020
ms.locfileid: "77540132"
---
...
*Reliable Services* 是 Service Fabric 上可用的编程模型之一。 另一个编程模型是 *Reliable Actor*，它在 Reliable Services 模型的顶层提供 [Virtual Actor](https://research.microsoft.com/projects/orleans/) 应用程序框架。 有关 Reliable Actors 的详细信息，请参阅 [Service Fabric Reliable Actors 简介](service-fabric-reliable-actors-introduction.md)。
...
无论服务有状态还是无状态，Reliable Services 都会提供简单的生命周期，以便快速插入代码并开始执行。  启动并运行新服务需要实现两个方法：
...
如果这是你第一次学习 Reliable Services，请继续阅读！ 如果你正在寻找 Reliable Services 生命周期的详细演练，请查看 [Reliable Services 生命周期概述](service-fabric-reliable-services-lifecycle.md)。
...
Service Fabric 中常见的无状态服务使用示例是作为前端，它公开 Web 应用程序的面向公众的 API。 然后，该前端服务指示有状态服务完成用户的请求。 在这种情况下，来自客户端的调用将定向到无状态服务正在侦听的某个已知端口（如 80）。 此无状态服务接收调用，并判断调用是否来自可信方以及其目标服务是哪一个。  然后，此无状态服务将调用转发到有状态服务的正确分区并等待响应。 无状态服务收到响应后，会回复原始客户端。 此类服务的示例是 *Service Fabric 入门*示例 ([C#](https://github.com/Azure-Samples/service-fabric-dotnet-getting-started) / [Java](https://github.com/Azure-Samples/service-fabric-java-getting-started))，以及该存储库中的其他 Service Fabric 示例。
