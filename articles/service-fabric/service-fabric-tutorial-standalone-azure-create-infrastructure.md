...
Service Fabric 独立群集提供相应的选项让我们选择自己的环境，并创建群集作为 Service Fabric 所采用的“任意 OS、任意云”方案的一部分。 在本系列教程中，我们将创建一个托管在 Azure VM 上的独立群集，并将应用程序安装到其中。
...
需要一个 Azure 订阅才能完成此教程。  如果没有帐户，请转到 [Azure 门户](https://portal.azure.cn)创建一个帐户。
