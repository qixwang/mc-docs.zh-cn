...
ms.date: 05/25/2020
ms.topic: conceptual
ms.openlocfilehash: fa3e47544a246ce3de039af1ec033a7d8fd9a79d
ms.sourcegitcommit: 981a75a78f8cf74ab5a76f9e6b0dc5978387be4b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/22/2020
ms.locfileid: "83801278"
---
...
5. 修改后的 Runbook 的名称将发送为已签入 Runbook 的输入参数。 可以通过在“存储库同步”页面中展开 Runbook 来[查看作业详细信息](automation-runbook-execution.md#job-statuses)。  
...
2. “同步”将启动 Sync-MicrosoftAzureAutomationAccountFromGitHubV1 runbook，后者将连接到 GitHub 并将更改内容从存储库拉取到 Azure 自动化。 此操作的“存储库同步”页面中应该会显示一个新作业。 若要查看同步作业的详细信息，请单击以打开作业详细信息页面。  
