...
ms.openlocfilehash: c58fca020c8afeea0dab6351c28bec00e4b6473d
ms.sourcegitcommit: 981a75a78f8cf74ab5a76f9e6b0dc5978387be4b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/22/2020
ms.locfileid: "83801924"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-automation"></a>Azure 自动化的 Azure Policy 内置策略定义

本页是 Azure 自动化的 [Azure Policy](../governance/policy/overview.md) 内置策略定义的索引。 有关其他服务的其他 Azure Policy 内置定义，请参阅 [Azure Policy 内置定义](../governance/policy/samples/built-in-policies.md)。
