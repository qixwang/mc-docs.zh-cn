...
|[Add-AzureCertificate](https://docs.microsoft.com/powershell/module/servicemanagement/azure/add-azurecertificate)|为指定的云服务上传服务证书。|
...
### <a name="create-a-new-certificate-with-resource-manager-template"></a>使用资源管理器模板创建新证书
