...
使用 [Register-AzAutomationScheduledRunbook](https://docs.microsoft.com/powershell/module/Az.Automation/Register-AzAutomationScheduledRunbook?view=azps-3.7.0) cmdlet 链接计划。 可以使用 Parameters 参数为 Runbook 的参数指定值。 有关如何指定参数值的详细信息，请参阅[在 Azure 自动化中启动 Runbook](../start-runbooks.md)。
