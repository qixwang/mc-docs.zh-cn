...
| [使用 Windows 版 AzCopy 跨存储账户迁移 Blobs](../scripts/storage-common-transfer-between-storage-accounts.md?toc=%2fpowershell%2fmodule%2ftoc.json)| 使用 Windows 版 AzCopy 跨 Azure 存储账户迁移 Blob。 |
|**Blob 存储**||
