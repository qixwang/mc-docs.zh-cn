...
自动化脚本旨在用于 Azure 资源管理器部署而不是存储内容操作。 有关详细信息，请参阅[使用资源管理器模板和 Azure PowerShell 部署资源](../../azure-resource-manager/resource-group-template-deploy.md)。
...
-  [Azure 存储安全指南](storage-security-guide.md)
