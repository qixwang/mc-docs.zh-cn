---
title: 使用 Site Recovery 设置 VMM 云中的本地 Hyper-V VM 到 Azure 的灾难恢复
...
3. 安装后，在“Azure Site Recovery 注册向导”>“保管库设置”中，选择“浏览”，然后在“密钥文件”中选择下载的保管库密钥文件    。
