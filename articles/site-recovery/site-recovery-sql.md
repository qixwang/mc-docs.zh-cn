...
1. 导入相应的脚本，用于在[资源管理器虚拟机](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/asr-automation-recovery/scripts/ASR-SQL-FailoverAG.ps1)和[经典虚拟机](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/asr-automation-recovery/scripts/ASR-SQL-FailoverAGClassic.ps1)中对 SQL 可用性组进行故障转移。 将脚本导入到 Azure 自动化帐户中。
    ...
    [![“部署到 Azure”徽标图像](https://azurecomcdn.azureedge.net/mediahandler/acomblog/media/Default/blog/c4803408-340e-49e3-9a1f-0ed3f689813d.png)](https://portal.azure.cn/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fazure%2Fazure-quickstart-templates%2Fmaster%2Fasr-automation-recovery%2F%2Fazuredeploy.json)
...
SQL Server 的 Site Recovery 复制已涵盖在“软件保障 - 灾难恢复”权益中。 这项权益适用于所有 Site Recovery 方案：本地到 Azure 的灾难恢复，以及跨区域的 Azure IaaS 灾难恢复。 有关详细信息，请参阅 [Azure Site Recovery 定价](https://www.azure.cn/pricing/details/site-recovery/)。
