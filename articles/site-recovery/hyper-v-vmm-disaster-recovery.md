...
5. 下载注册密钥。 安装提供程序时需要此密钥。 生成的密钥有效期为 5 天。
    ...
    :::image type="content" source="./media/hyper-v-vmm-disaster-recovery/source-settings.png" alt-text="用于下载提供程序和注册密钥的选项的屏幕截图。":::
...
5. 安装完成后，单击“注册”，以便在保管库中注册服务器。
    ...
    :::image type="content" source="./media/hyper-v-vmm-disaster-recovery/provider-register.png" alt-text="包括安装位置的提供程序安装屏幕的屏幕截图。":::
...
2. 此时会显示与 Site Recovery 同步的 VMM 云。 选择目标云。
    ...
    :::image type="content" source="./media/hyper-v-vmm-disaster-recovery/target-vmm.png" alt-text="目标 VMM 服务器和云选择内容的屏幕截图。":::
...
6. 如果要通过网络进行复制，请在“初始复制方法”中指定是要启动还是计划初始复制。 要节省网络带宽，可以将它计划在非高峰时间运行。 然后单击“确定”。
    ...
    :::image type="content" source="./media/hyper-v-vmm-disaster-recovery/replication-policy.png" alt-text="复制策略选项的屏幕截图。":::
