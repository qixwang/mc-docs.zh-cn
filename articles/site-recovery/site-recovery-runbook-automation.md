...
<!--REASON: Not Avaialble on automation/automation-runbook-gallery.md-->
...
- 如果刚开始接触 Azure 自动化，可以[注册](https://www.azure.cn/home/features/automation/)并下载示例脚本。
...
- 使用 [Azure 自动化变量](../automation/automation-variables.md)存储用于运行恢复计划的参数。
