...
此外，检查是否在 VM 中[安装了 Microsoft .NET 4.5](https://docs.microsoft.com/dotnet/framework/migration-guide/how-to-determine-which-versions-are-installed?view=azure-dotnet)。 需要具有 .NET 4.5，VM 代理才能与该服务进行通信。
