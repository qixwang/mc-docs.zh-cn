...
ms.date: 04/06/2020
ms.author: v-jay
ms.openlocfilehash: a6c7e50e0e2e830a66d13dd950697594ac60b5ef
ms.sourcegitcommit: fe9ed98aaee287a21648f866bb77cb6888f75b0c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/03/2020
ms.locfileid: "80625826"
---
# <a name="upgrade-azure-internal-load-balancer---outbound-connection-required"></a>升级 Azure 内部负载均衡器 - 需要出站连接
[Azure 标准负载均衡器](load-balancer-overview.md)提供丰富的功能和高可用性。 有关负载均衡器 SKU 的详细信息，请参阅[比较表](/load-balancer/concepts-limitations#skus)。 由于标准内部负载均衡器不提供出站连接，因此我们提供了一个解决方案，改为创建标准公共负载均衡器。
...
4. 为应该与 Internet 隔离的子网/VM 设置 NSG 规则
...
1. 使用相应的参数运行脚本。 完成该脚本可能需要 5 到 7 分钟时间。
   ...
   ```azurepowershell
   AzurePublicLBUpgrade.ps1 -oldRgName "test_publicUpgrade_rg" -oldLBName "LBForPublic" -newrgName "test_userInput3_rg" -newlocation "chinaeast2" -newLbName "LBForUpgrade"
   ```
