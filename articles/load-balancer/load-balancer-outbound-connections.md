...
### <a name="ilpip"></a>场景 1：使用公共 IP 地址的 VM
...
### <a name="lb"></a>场景 2：无公共 IP 地址的负载均衡 VM
...
用于 [PAT](#pat) 的[临时端口](#preallocatedports)是可用尽的资源，如[无公共 IP 地址的独立 VM](#defaultsnat) 和[无公共 IP 地址的负载均衡 VM](#lb) 中所述。
...
#### <a name="assignilpip"></a>向每个 VM 分配公共 IP
