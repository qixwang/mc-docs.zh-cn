...
有关详细信息，请参阅[负载均衡器限制](https://docs.azure.cn/zh-cn/azure-subscription-service-limits#load-balancer)。 对于标准负载均衡器，请参阅[概述](load-balancer-standard-overview.md)、[定价](https://www.azure.cn/zh-cn/pricing/details/load-balancer/)和 [SLA](https://www.azure.cn/zh-cn/support/sla/load-balancer/)。
...
有关标准负载均衡器 SLA 的信息，请参阅[负载均衡器的 SLA](https://www.azure.cn/zh-cn/support/sla/load-balancer/)。
