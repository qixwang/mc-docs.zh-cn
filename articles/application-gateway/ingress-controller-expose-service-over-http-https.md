...
这些教程有助于演示如何使用 [Kubernetes 入口资源](https://kubernetes.io/docs/concepts/services-networking/ingress/)，以便通过 [Azure 应用程序网关](https://www.azure.cn/home/features/application-gateway/)经 HTTP 或 HTTPS 公开示例 Kubernetes 服务。
