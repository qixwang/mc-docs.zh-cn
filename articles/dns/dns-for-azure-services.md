...
ms.date: 03/23/2020
ms.author: v-jay
ms.openlocfilehash: c3f58adfdfaaf380151eafac4f730679350d5356
ms.sourcegitcommit: 305361c96d1d5288d3dda7e81833820640e2afac
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/21/2020
ms.locfileid: "80109807"
---
...
| Azure 流量管理器 |公共名称 |可创建映射到分配给流量管理器配置文件的 trafficmanager.cn 名称的别名记录。 有关详细信息，请参阅[教程：使用流量管理器配置支持顶点域名的别名记录](tutorial-alias-tm.md)。 |
