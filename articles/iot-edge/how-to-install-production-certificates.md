...
ms.service: iot-edge
services: iot-edge
ms.openlocfilehash: 8c871af25deb9731065058eaa897419b59924faa
ms.sourcegitcommit: f5bc5bf51a4ba589c94c390716fc5761024ff353
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/20/2020
ms.locfileid: "77494476"
---
...
3. 将 config.yaml 文件中的 **certificate** 属性设置为 IoT Edge 设备上的证书和密钥文件的文件 URI。 删除 certificate 属性前面的 `#` 字符，以取消注释四个代码行。 请确保 **certificates:** 行前面没有空格，并且嵌套项缩进了两个空格。 例如：
...
5. 如果以前在设备上使用过 IoT Edge 的任何其他证书，请在启动或重启 IoT Edge 之前删除以下两个目录中的文件：
