...
services: iot-edge
ms.custom: seodec18
ms.openlocfilehash: 62e419bdbb3ad77475c69bbce977cc39b978241c
ms.sourcegitcommit: a890a9cca495d332c9f3f53ff3a5259fd5f0c275
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/10/2020
ms.locfileid: "75859588"
---
...
2. 检索每个证书的 SHA1 指纹 - 包含 40 个十六进制字符的字符串。 使用以下 openssl 命令查看证书并查找指纹：
   ...
   运行此命令两次，一次面向主要证书，另一次面向辅助证书。 使用自签名的 X.509 证书注册新 IoT 设备时，为这两个证书提供指纹。 
...
如果你为此下游设备建立了父/子关系（这对于 X.509 身份验证是必需操作，但对于对称密钥身份验证为可选操作），可以通过直接调用充当连接主机的网关来简化连接字符串。 例如： 
