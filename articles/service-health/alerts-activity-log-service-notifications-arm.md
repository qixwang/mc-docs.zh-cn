...
以下模板将创建以电子邮件为目标的操作组，并为目标订阅启用所有服务运行状况通知。 将此模板另存为 CreateServiceHealthAlert.json。
...
- [Microsoft.Insights/actionGroups](https://docs.microsoft.com/azure/templates/microsoft.insights/actiongroups)
- [Microsoft.Insights/activityLogAlerts](https://docs.microsoft.com/azure/templates/microsoft.insights/activityLogAlerts)

## <a name="deploy-the-template"></a>部署模板

使用[部署 ARM 模板](../azure-resource-manager/templates/deploy-portal.md)的任何标准方法来部署模板，如以下使用 CLI 和 PowerShell 的示例。 将“资源组”和“emailAddress”的示例值替换为环境的相应值 。
