...
ms.openlocfilehash: 154739234fec9f4df2e827aaef8bd0eca9594cd4
ms.sourcegitcommit: 2bd0be625b21c1422c65f20658fe9f9277f4fd7c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/17/2020
ms.locfileid: "86440968"
---
...
对于不支持的存储解决方案，为了在 ML 试验期间节省数据出口成本，请[将数据移到](#move)支持的 Azure 存储解决方案。  可从[这些 Azure 存储解决方案](#matrix)创建数据存储。 
...
可在 [Azure 门户](https://portal.azure.cn)上找到填充表单所需的信息。 在左窗格中选择“存储帐户”，并选择要注册的存储帐户。 “概述”页面提供了帐户名称、容器和文件共享名称等信息。 
