...
ms.openlocfilehash: 4adab93c504f97d38fe77ff16ee348fa4d2b2dc3
ms.sourcegitcommit: 2bd0be625b21c1422c65f20658fe9f9277f4fd7c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/17/2020
ms.locfileid: "86440949"
---
...
本示例展示了 [Team Data Science Process](/machine-learning/team-data-science-process/) 中的各个步骤。 NYC 出租车行程和车费 2013 数据集的一个子集用于加载、探索和准备数据。 然后，使用 Spark MLlib，对二元分类和回归模型进行训练，以预测是否将为行程支付小费并估算小费金额。
