...
ms.openlocfilehash: 18d0705c75e5fcfa46716847e7d3d8800c80843d
ms.sourcegitcommit: 623d64ef33e80d5f84b6dcf6d1ef4120fe4b8c08
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/02/2020
ms.locfileid: "75598938"
---
...
1. **Java 堆空间**：对于涉及联接大数据集或处理长记录的查询，常见的一个错误为“堆空间不足”  。 可以通过将参数 mapreduce.map.java.opts 和 mapreduce.task.io.sort.mb 设置为所需的值来避免此错误   。 以下是示例：
