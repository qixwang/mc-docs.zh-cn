...
ms.reviewer: peterlu
ms.date: 11/04/2019
ms.openlocfilehash: 4ad41d15df7480d36c0f62d47e3c4f7f3b197b90
ms.sourcegitcommit: 623d64ef33e80d5f84b6dcf6d1ef4120fe4b8c08
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/02/2020
ms.locfileid: "75599353"
---
...
因为此问题回答“哪一个？”, 所以这称为分类问题。 但是，你可以应用相同的基本过程来解决任何类型的机器学习问题，无论是回归、分类，还是聚类等等。
...
此数据集包含 14 个特征和一个标签列。 有多种类型的特征，包括数字特征和类别特征。 下图显示了来自数据集的摘录：![数据](./media/how-to-designer-sample-classification-predict-income/data.png)
