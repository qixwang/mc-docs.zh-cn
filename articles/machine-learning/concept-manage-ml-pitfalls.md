...
ms.author: nibaccam
ms.date: 04/09/2020
ms.openlocfilehash: d2d65ed80e51222b53e54882d1f1a26b4c025734
ms.sourcegitcommit: 2bd0be625b21c1422c65f20658fe9f9277f4fd7c
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/17/2020
ms.locfileid: "86441119"
---
...
- 查看不平衡数据的性能指标。 例如，F1 评分是精准率和召回率的加权平均值。 精准率测量分类器的准确度，低精准率表示存在大量假正例；召回率测量分类器的完成度，低召回率表示存在大量假反例。
