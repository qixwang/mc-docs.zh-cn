...
可以从预安装的 Firefox 浏览器访问 [Azure 门户](https://portal.azure.cn)。 在 Azure 门户中，可以创建、管理和监视 Azure 资源。
...
通过将已构建的机器学习模型包装在 Web 服务接口中，来对它们执行操作。 实施机器学习模型使得以任何语言编写的客户端都能从这些模型中调用预测。 有关详细信息，请参阅[机器学习文档](/machine-learning/)。
