...
ms.topic: conceptual
ms.date: 05/08/2018
ms.openlocfilehash: d444bf4001ef77e18afad37f0786f9374cf91fdd
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "75599042"
---
...
如果已有 Active Directory，可以将它用作通用标识提供者。 如果没有 Active Directory，则可以通过 [Azure Active Directory 域服务](/active-directory-domain-services/) (Azure AD DS) 在 Azure 上运行托管的 Active Directory 实例。

[Azure AD](/active-directory/) 的文档提供了详细的[托管说明](/active-directory/choose-hybrid-identity-solution)，包括如何将 Azure AD 连接到本地目录的相关指南（如果有）。
...
1. 在 Azure 门户中，将用户添加到 Active Directory： 
   ...
   1. 使用属于目录全局管理员的帐户登录到 [Azure Active Directory 管理中心](https://aad.portal.azure.cn)。
