...
ms.topic: conceptual
ms.date: 12/10/2018
ms.openlocfilehash: 550099cdda35561331b1b4964c852cb5b62de9e6
ms.sourcegitcommit: 623d64ef33e80d5f84b6dcf6d1ef4120fe4b8c08
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/02/2020
ms.locfileid: "75599026"
---
...
虚拟机规模集支持自动缩放。 可以设置有关何时创建其他实例以及何时减小实例的规则。 例如，可以缩减至零个实例以在未使用任何 VM 的情况下节省云硬件的使用成本。 VM 规模集的文档页提供了有关[自动缩放](/virtual-machine-scale-sets/virtual-machine-scale-sets-autoscale-overview)的详细步骤。
