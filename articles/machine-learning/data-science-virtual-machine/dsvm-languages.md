...
> [!NOTE]
> 2018 年 3 月之前创建的 Windows Server 2016 版本包含 Python 3.5 和 Python 2.7。 Python 2.7 是 conda 根环境，而 py35 是 Python 3.5 环境   。
...
* 在 Jupyter 中使用：
  ...
  打开 Jupyter，然后选择“新建”以创建新的笔记本  。 可以将 Python 3.6 的内核类型设置为“Python [Conda Root]”，而将 Python 2.7 的内核类型设置为“Python [Conda env:python2]”   。
