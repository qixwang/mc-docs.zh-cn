...
使用此模块可以运行 Python 代码。 有关 Python 的体系结构和设计原则的详细信息，请参阅[以下文章](/machine-learning/machine-learning-execute-python-scripts)。
...
6. 运行管道，或者选择模块，然后单击“运行所选”  以便仅运行 Python 脚本。
