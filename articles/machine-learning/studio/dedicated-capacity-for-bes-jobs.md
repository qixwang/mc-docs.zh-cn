...
description: 适用于机器学习工作室（经典）作业的 Azure Batch 服务概述。 可以通过批处理池处理创建池，在其中提交批处理作业。
...
ms.date: 04/19/2017
ms.openlocfilehash: 1efd8618be5f11b15343963c71a31711bbf0f43e
ms.sourcegitcommit: 6ddc26f9b27acec207b887531bea942b413046ad
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 03/27/2020
ms.locfileid: "80343077"
---
# <a name="azure-batch-service-for-azure-machine-learning-studio-classic-jobs"></a>适用于 Azure 机器学习工作室（经典）作业的 Azure Batch 服务
...
批处理池处理是一项始终开启的计费服务，需要将其与基于 Resource Manager 的计费计划相关联。 计费基于运行池时的计算小时数，与该段时间在池中运行的作业数无关。 如果创建了池，则在删除池之前，系统会针对池中每个虚拟机的计算小时数计费，即使池中没有批处理作业运行。 对虚拟机的计费在虚拟机完成预配后开始，在删除虚拟机后停止。 可以使用[机器学习定价页](https://www.azure.cn/pricing/details/machine-learning/)中提供的任何计划。
...
|---|---|
|需要运行大量作业<br>或<br/>需要确定作业将立即运行<br/>或<br/>需要吞吐量保证。 例如，需要在给定时段内运行多项作业，且需按需求扩大计算资源。    | 只运行数项作业<br/>和<br/> 不需立即运行作业 |
