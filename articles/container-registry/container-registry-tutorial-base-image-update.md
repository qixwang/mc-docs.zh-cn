...
<!--Not Available on (not in the Cloud Shell)-->
<!--Not Available on  If you're using the local Shell, skip this section (Cloud Shell does not support `docker run`).-->
...
[az-acr-task-list-runs]: https://docs.azure.cn/cli/acr?view=azure-cli-latest
[az-acr-task]: https://docs.azure.cn/cli/acr?view=azure-cli-latest
