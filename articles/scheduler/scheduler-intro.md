...
description: 创建计划，并运行调用 Azure 内部或外部服务的自动化作业
services: scheduler
...
其他 Azure 计划功能也在后台使用计划程序，例如，[Azure WebJobs](../app-service/webjobs-create.md)，这是 Azure 应用服务中的一个 [Web 应用](/app-service/web/)功能。 可以使用[计划程序 REST API](https://docs.microsoft.com/rest/api/scheduler/) 来管理这些操作的通信，该 API 可以帮助你管理这些操作的通信。
...
* [使用 Azure 计划程序生成复杂的计划和高级重复周期](scheduler-advanced-complexity.md)
