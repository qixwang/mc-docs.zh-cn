...
- [本机客户端](../develop/developer-glossary.md?toc=/active-directory/azuread-dev/toc.json&bc=/active-directory/azuread-dev/breadcrumb/toc.json#native-client)应用程序（iOS、Android、.NET 桌面或 Xamarin）
- 调用[资源](../develop/developer-glossary.md?toc=/active-directory/azuread-dev/toc.json&bc=/active-directory/azuread-dev/breadcrumb/toc.json#resource-server) (.NET) 的 [Web 客户端](../develop/developer-glossary.md?toc=/active-directory/azuread-dev/toc.json&bc=/active-directory/azuread-dev/breadcrumb/toc.json#web-client)应用程序
...
[AAD-Integrating-Apps]:../develop/quickstart-register-app.md
