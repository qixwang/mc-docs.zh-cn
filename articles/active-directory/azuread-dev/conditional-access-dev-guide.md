...
本文假定你了解[单租户和多租户](../develop/howto-convert-app-to-be-multi-tenant.md?toc=/active-directory/azuread-dev/toc.json&bc=/active-directory/azuread-dev/breadcrumb/toc.json)应用以及[常见的身份验证模式](v1-authentication-scenarios.md)。
