...
ms.openlocfilehash: 9d44c54648ff07ab325355945804ab5f6a96fae6
ms.sourcegitcommit: 92b9b1387314b60661f5f62db4451c9ff2c49500
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/09/2020
ms.locfileid: "86165025"
---
...
- 应用程序管理员：具有此角色的用户可以创建和管理企业应用程序和应用程序注册的所有方面。 此角色还授予同意委派权限和应用程序权限（不包括 Microsoft Graph）的能力。 在创建新应用程序注册或企业应用程序时，不会将分配到此角色的用户添加为所有者。
- 云应用程序管理员：具有此角色的用户具有与应用程序管理员角色相同的权限。 在创建新应用程序注册或企业应用程序时，不会将分配到此角色的用户添加为所有者。
