...
ms.openlocfilehash: b7d9bd3e0711d91a1b767b88f5b974baf45b73ed
ms.sourcegitcommit: 1008ad28745709e8d666f07a90e02a79dbbe2be5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/03/2020
ms.locfileid: "85945316"
---
...
>[!NOTE]
>目前，此公共预览版仅适用于 Azure 全球云，不适用于[国家云](/active-directory/develop/authentication-national-cloud)。
...
建议按照[交叉迁移](/active-directory/hybrid/how-to-upgrade-previous-version#swing-migration)方法在环境中推出新的终结点。 这将在事件中提供清晰的应变计划，即主要回滚必不可少。 以下示例说明如何在这种情况下使用交叉迁移。 有关交叉迁移部署方法的详细信息，请参考提供的链接。 
...
>[!NOTE]
> 如果 O365 统一组的成员超过 5 万，则这些组将被读入 Azure AD Connect。 
