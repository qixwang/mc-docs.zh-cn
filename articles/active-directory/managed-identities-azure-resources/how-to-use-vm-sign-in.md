...
如果打算使用本文中的 Azure PowerShell 或 Azure CLI 示例，请务必安装最新版本的 [Azure PowerShell](https://docs.microsoft.com/powershell/azure/install-az-ps) 或 [Azure CLI](/cli/install-azure-cli)。 
