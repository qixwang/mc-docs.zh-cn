...
若要直接访问使用情况和见解，请转到 [https://portal.azure.cn/#blade/Microsoft_AAD_IAM/AuthMethodsOverviewBlade](https://portal.azure.cn/#blade/Microsoft_AAD_IAM/AuthMethodsOverviewBlade)。 单击此链接会转到注册概述。
