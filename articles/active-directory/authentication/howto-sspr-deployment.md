...
注册和密码重置的审核日志可供使用 30 天。 因此，如果企业中的安全审核需要更长的保留期，则需要导出日志，并在 Splunk 或 ArcSight 等 SIEM 工具中使用它。
...
在运行 1803 或更高版本的、已加入 Azure AD 或混合 Azure AD 的 Windows 10 设备上，用户可在 Windows 登录屏幕上重置其密码。 有关配置此功能的信息和步骤，请参阅[从登录屏幕重置 Azure AD 密码](howto-sspr-windows.md)一文
