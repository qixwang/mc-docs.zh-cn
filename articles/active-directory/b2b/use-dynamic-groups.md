...
ms.openlocfilehash: d3101762f8535eae012973b83b18617720ab698e
ms.sourcegitcommit: 95efd248f5ee3701f671dbd5cfe0aec9c9959a24
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/29/2020
ms.locfileid: "82515644"
---
...
Azure Active Directory (Azure AD) 的安全组成员身份动态配置在 [Azure 门户](https://portal.azure.cn)中提供。 管理员可以设置规则以填充在 Azure AD 中基于用户属性（如 userType、部门或国家/地区）创建的组。 可基于成员属性自动在安全组中添加或删除成员。 这些组可以为成员提供对应用程序或云资源（SharePoint 站点、文档）的访问权限并分配许可证。 

创建和使用动态组需要相应的 [Azure AD Premium P1 或 P2 授权](https://www.azure.cn/pricing/details/active-directory/)。 

## <a name="creating-an-all-users-dynamic-group"></a>创建“所有用户”动态组
可使用成员资格规则创建包含租户中所有用户的组。 以后向租户添加用户或从中删除用户时，将自动调整该组的成员资格。

1. 使用在租户中分配有全局管理员或用户管理员角色的帐户登录到 [Azure 门户](https://portal.azure.cn)。
