...
ms.openlocfilehash: e9bef38f4cf4831261e47b06fd8981fbec331651
ms.sourcegitcommit: 1008ad28745709e8d666f07a90e02a79dbbe2be5
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/03/2020
ms.locfileid: "85945077"
---
...
| 单一登录：支持 SSO 到所有 Azure AD 连接的应用。          | 单一登录：支持 SSO 到所有 Azure AD 连接的应用。    | 单一登录：支持在 Azure AD B2C 租户中单一登录到客户自有应用。 不支持单一登录到 Office 365 或其他 Microsoft SaaS 应用。    |
