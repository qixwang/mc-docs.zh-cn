...
必须拥有[最新版本](https://docs.microsoft.com/powershell/azure/install-az-ps) PowerShell 才能演练本文中的示例。
...
若要更改 AD 应用的凭据（由于安全性损害或凭据过期），请使用 [Remove-AzADAppCredential](https://docs.microsoft.com/powershell/module/az.resources/remove-azadappcredential) 和 [New-AzADAppCredential](https://docs.microsoft.com/powershell/module/az.resources/new-azadappcredential) cmdlet。
