...
有关更多详细信息，请参阅 [Microsoft 标识平台 (v2.0) 终结点有何不同？](/active-directory/develop/azure-ad-endpoint-comparison)。
...
| 不适用 | 具有持久性的缓存，可从 [MSAL 扩展](https://github.com/marstr/original-microsoft-authentication-extensions-for-python)获取 |
