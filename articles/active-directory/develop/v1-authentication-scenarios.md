...
ms.openlocfilehash: e7c1f47012154ee5198eb6d4bc54ada11fdda134
ms.sourcegitcommit: 1bc154c816a5dff47ee051c431cd94826e57aa60
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/09/2020
ms.locfileid: "75776910"
---
...
* 开发人员可以使用开源 Azure AD 身份验证库处理协议细节，方便你进行身份验证。 有关详细信息，请参阅 Microsoft 标识平台 [v2.0 身份验证库](reference-v2-libraries.md)和 [v1.0 身份验证库](active-directory-authentication-libraries.md)。
...
下表提供了由 Azure AD 发出的每种声明的简要说明。 有关详细信息，请参阅 Azure AD 颁发的[访问令牌](access-tokens.md)和 [ID 令牌](id-tokens.md)。
