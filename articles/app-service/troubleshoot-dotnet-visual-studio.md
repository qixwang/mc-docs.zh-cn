...
* **应用程序跟踪日志**<br/>
  应用程序通过调用 [System.Diagnostics.Trace](https://docs.microsoft.com/dotnet/api/system.diagnostics.trace) 类的方法创建这些日志。
* **Web 服务器日志**<br/>
...
4. 在 [Azure 门户](https://portal.azure.cn)中应用的“设置”页上，单击“部署凭据”，然后输入新的用户名和密码 。
