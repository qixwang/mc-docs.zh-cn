...
1. 在“验证提供程序”下，选择“Azure Active Directory”   。 在“管理模式”下，选择“高级”。   粘贴前面获取的应用程序（客户端）ID 和客户端机密。 对于“颁发者 URL”字段，请使用 **https://login.partner.microsoftonline.cn/9188040d-6c67-4c5b-b112-36a304b66dad/v2.0** 。 
1. 选择“确定”  。
