...
ms.date: 04/28/2020
ms.author: v-junlch
ms.openlocfilehash: bc56c5d1b86fc2b8849f67e98c900af8bce99327
ms.sourcegitcommit: e3512c5c2bbe61704d5c8cbba74efd56bfe91927
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/29/2020
ms.locfileid: "82267617"
---
...
如果不再需要资源组、规模集，可以使用 [Remove-AzResourceGroup](https://docs.microsoft.com/powershell/module/az.resources/remove-azresourcegroup) 命令将其删除。 `-Force` 参数将确认是否希望删除资源，而不会有额外提示。 `-AsJob` 参数会使光标返回提示符处，无需等待操作完成。
