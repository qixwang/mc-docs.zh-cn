...
- 详细了解 `provisionAfterExtensions` 属性：[Microsoft.Compute virtualMachineScaleSets/extensions 模板参考](https://docs.microsoft.com/azure/templates/microsoft.compute/2018-10-01/virtualmachinescalesets/extensions)。
