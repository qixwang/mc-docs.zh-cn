...
ms.openlocfilehash: c8052afa945f09e176e663e5fe2b038ec3a4eff5
ms.sourcegitcommit: 0e778acf5aa5eb63ab233e07e7aecce3a9a5e6d4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/28/2020
ms.locfileid: "87296503"
---
...
通过将 clientId 传递给 [az keyvault set-policy](/cli/keyvault?view=azure-cli-latest#az-keyvault-set-policy) 命令，为密钥保管库创建授予服务主体权限的访问策略。 授予服务主体对密钥的 get、list 和 create 权限。
...
可以使用 [az keyvault key show](/cli/keyvault/key?view=azure-cli-latest#az-keyvault-key-show) 命令来验证是否设置了密钥：
...
可以使用 [az keyvault key show](/cli/keyvault/key?view=azure-cli-latest#az-keyvault-key-show) 命令来验证密钥是否已删除：
