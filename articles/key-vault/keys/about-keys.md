...
ms.date: 04/20/2020
ms.author: v-tawe
ms.openlocfilehash: d5efe24ab17838e028b7821e64a1d95cf63bd7f0
ms.sourcegitcommit: 89ca2993f5978cd6dd67195db7c4bdd51a677371
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/30/2020
ms.locfileid: "82588830"
---
# <a name="about-azure-key-vault-keys"></a>关于 Azure Key Vault 密钥

Microsoft Azure 应用程序和用户可以通过 Azure Key Vault 来存储和使用密钥。
...
-   **Identity** - Azure Active Directory (Azure AD) 提供的标识。  
