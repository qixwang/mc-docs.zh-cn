...
为了进一步简化管理，我们还使用了包含 Key Vault 的同一个资源组。 在 [入门教程](../secrets/quick-create-cli.md)中，此资源组的名称为 **ContosoResourceGroup**，我们将继续使用“东亚”位置。 在适当的情况下，请将这些值替换为自己的值：
...
在[入门教程](../secrets/quick-create-cli.md)中，Key Vault 名称为 **ContosoKeyVault**。 我们将继续使用该名称，并将详细信息存储在名为 **kv** 的变量中：
