...
ms.topic: tutorial
ms.openlocfilehash: 5eb489190759359c26ebd9f209471812342411cf
ms.sourcegitcommit: 0e778acf5aa5eb63ab233e07e7aecce3a9a5e6d4
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/28/2020
ms.locfileid: "87296538"
---
...
4. Azure Key Vault 防火墙决定是否允许调用。
    ...
    * 应用场景 2：调用方是 Azure Key Vault 信任的服务。 如果选择了此选项，某些 Azure 服务可以绕过密钥保管库防火墙。 [Key Vault 信任的服务列表](https://docs.azure.cn/key-vault/general/overview-vnet-service-endpoints#trusted-services)
...
1. 如果尚未创建服务主体，请创建一个。 [创建服务主体](https://docs.azure.cn/active-directory/develop/howto-create-service-principal-portal)
...
1. 创建证书
    ...
    * 选项 2：使用密钥保管库创建证书。 [在 Azure Key Vault 中创建证书](https://docs.azure.cn/key-vault/certificates/certificate-scenarios#creating-your-first-key-vault-certificate)
...
1. 创建 Azure Key Vault [链接](https://docs.azure.cn/key-vault/secrets/quick-create-portal#create-a-vault)
...
1. 了解如何对密钥保管库身份验证错误进行故障排除。 [Key Vault 故障排除指南](https://docs.azure.cn/key-vault/general/rest-error-codes)
