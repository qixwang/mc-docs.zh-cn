...
ms.author: v-tawe
ms.custom: mvc
ms.openlocfilehash: 433d9e38901517f1c4a630b1c4d813f29cb910e1
ms.sourcegitcommit: 89ca2993f5978cd6dd67195db7c4bdd51a677371
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/30/2020
ms.locfileid: "82588965"
---
...
对于 Windows、Mac 和 Linux：
  ...
  * 本教程要求在本地运行 Azure CLI。 必须安装 Azure CLI 2.0.4 或更高版本。 运行 `az --version` 即可查找版本。 如果需要安装或升级 CLI，请参阅[安装 Azure CLI 2.0](/cli/install-azure-cli?view=azure-cli-latest)。
