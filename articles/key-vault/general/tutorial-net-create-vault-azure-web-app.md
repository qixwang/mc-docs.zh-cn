...
ms.author: v-tawe
ms.custom: mvc
ms.openlocfilehash: 275f7f5abf59c036054767d0ff4d0ae717a8cff0
ms.sourcegitcommit: 89ca2993f5978cd6dd67195db7c4bdd51a677371
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/30/2020
ms.locfileid: "82588986"
---
...
请将 \<YourAppName> 替换为 Azure 上发布的应用的名称。  
    例如，如果发布的应用名为 **MyAwesomeapp.chinacloudsites.cn**，请将 \<YourAppName> 替换为 **MyAwesomeapp**。
...
>[!NOTE]
>此过程中的命令等同于转到 [Azure 门户](https://portal.azure.cn)并在 Web 应用程序属性中将“标识/系统分配”设置切换为“打开”  。 
