...
ms.date: 04/20/2020
ms.openlocfilehash: 59d28e704a1fdf06815563fe62a63428d937c812
ms.sourcegitcommit: 89ca2993f5978cd6dd67195db7c4bdd51a677371
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/30/2020
ms.locfileid: "82588904"
---
# <a name="azure-key-vault-soft-delete-overview"></a>Azure Key Vault 软删除概述

Key Vault 的软删除功能允许恢复已删除的保管库和保管库对象，称为软删除。 本文将具体探讨以下方案：
...
软删除功能最初通过 [REST](https://docs.microsoft.com/rest/api/keyvault/)、[CLI](soft-delete-cli.md)、[PowerShell](soft-delete-powershell.md) 和 [.NET/C#](/dotnet/api/microsoft.azure.keyvault?view=azure-dotnet) 接口提供。
