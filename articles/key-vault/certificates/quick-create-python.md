...
ms.topic: quickstart
ms.openlocfilehash: 14d8faeeb5231d404d8d5a657214bcb3873677c6
ms.sourcegitcommit: 89ca2993f5978cd6dd67195db7c4bdd51a677371
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/30/2020
ms.locfileid: "82588873"
---
...
通过将 clientId 传递给 [az keyvault set-policy](/cli/keyvault?view=azure-cli-latest#az-keyvault-set-policy) 命令，为密钥保管库创建授予服务主体权限的访问策略。 授予服务主体对证书的 get、list 和 create 权限。
...
可以使用 [az keyvault certificate show](/cli/keyvault/certificate?view=azure-cli-latest#az-keyvault-certificate-show) 命令来验证是否设置了证书：
...
可以使用 [az keyvault certificate show](/cli/keyvault/certificate?view=azure-cli-latest#az-keyvault-certificate-show) 命令来验证证书是否已删除：
