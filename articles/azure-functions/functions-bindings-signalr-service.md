...
此系列文章介绍如何在 Azure Functions 中使用 SignalR 服务绑定进行身份验证，并向连接到 [Azure SignalR 服务](https://www.azure.cn/home/features/signalr-service/)的客户端发送实时消息。 Azure Functions 支持 SignalR 服务的输入和输出绑定。
