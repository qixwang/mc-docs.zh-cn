...
1. 在 [Azure 门户](https://portal.azure.cn)中，找到你的函数应用并选择它。 选择“概述”  选项卡，然后选择“停止”  。  停止函数应用可解锁文件，以便进行更改。

1. 选择“平台功能”  选项卡，然后在“开发工具”  下选择“高级工具(Kudu)”  。 Kudu 终结点 (`https://<APP_NAME>.scm.chinacloudsites.cn/`) 将在一个新窗口中打开。
