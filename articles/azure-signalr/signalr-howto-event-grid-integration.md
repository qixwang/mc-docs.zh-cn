...
<!-- LINKS - Internal -->
[az-eventgrid-event-subscription-create]: https://docs.microsoft.com/cli/azure/eventgrid/event-subscription#az-eventgrid-event-subscription-create
[az-group-create]: /cli/group#az-group-create
