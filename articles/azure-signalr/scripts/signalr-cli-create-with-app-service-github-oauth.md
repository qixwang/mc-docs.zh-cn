...
ms.author: v-tawe
ms.custom: mvc
ms.openlocfilehash: b69071b347dad5c294fad44d64f6f07acda18d64
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "75600577"
---
...
| [az appservice plan create](/cli/appservice/plan#az-appservice-plan-create) | 创建用于托管 Web 应用的 Azure 应用服务计划。 |
| [az webapp create](/cli/webapp#az-webapp-create) | 使用应用服务托管计划创建 Azure Web 应用。 |
| [az webapp config appsettings set](/cli/webapp/config/appsettings#az-webapp-config-appsettings-set) | 为 Web 应用添加新的应用设置。 这些应用设置用于存储 SignalR 连接字符串和 GitHub OAuth 应用密钥。 |
| [az webapp deployment user set](/cli/webapp/deployment/user#az-webapp-deployment-user-set) | 更新部署凭据。 |
| [az webapp deployment source config-local-git](/cli/webapp/deployment/source#az-webapp-deployment-source-config-local-git) | 获取 git 存储库终结点的 URL 用于为 web 应用部署克隆和推送。 |
