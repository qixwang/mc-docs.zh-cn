...
* [Azure Functions](https://www.azure.cn/home/features/azure-functions/) - 用于验证用户身份和发送聊天消息的后端 API
* [Azure SignalR 服务](https://www.azure.cn/home/features/signalr-service/) - 将新消息广播到连接的聊天客户端
* [Azure 存储](https://www.azure.cn/home/features/storage/) - 托管聊天客户端 UI 的静态网站
...
应用服务身份验证支持使用 Azure Active Directory 和 Microsoft 帐户的身份验证。
...
1. 可以使用 Azure Active Directory 或 Microsoft 帐户为应用程序配置身份验证。 通过设置 `authProvider` 的值来选择要使用的身份验证提供程序。
