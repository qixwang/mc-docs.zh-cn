...
可以使用 [zip 部署](../azure-functions/deployment-zip-push.md)和[从包运行](../azure-functions/run-functions-from-deployment-package.md)等技术，像部署任何典型 Azure 函数应用一样，来部署与 Azure SignalR 服务集成的 Azure 函数应用。
