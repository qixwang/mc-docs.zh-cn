...
<!--Not Available on [!INCLUDE [cloud-shell-try-it.md](../../includes/cloud-shell-try-it.md)]-->
...
如果使用 PowerShell 创建 SSH 密钥对，密钥对将存储在本地计算机上。 

<!--Not Available on [storage account is automatically created](https://docs.microsoft.com/azure/cloud-shell/persisting-shell-storage)-->
