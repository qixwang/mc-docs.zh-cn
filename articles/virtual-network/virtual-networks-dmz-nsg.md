...
ms.date: 04/22/2019
ms.author: v-yeche
ms.openlocfilehash: 89283decaa4b8f37303414620224fbea8a4fb06a
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "63855160"
---
...
本示例创建一个原始的外围网络，其中包含四个 Windows Server 和网络安全组。 本示例介绍了每个相关的模板部分，帮助用户更好地理解每一步。 另外还提供了“流量方案”部分，帮助用户逐步深入了解流量如何流经外围网络的各个防御层。 最后的“参考”部分提供了完整的模板代码，并说明如何构建此环境来测试和试验各种方案。 
...
1. 按以下说明部署 Azure 资源管理器模板：[Azure 快速启动模板][Template]
