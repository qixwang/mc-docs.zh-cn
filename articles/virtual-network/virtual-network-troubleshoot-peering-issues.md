...
ms.date: 06/15/2020
ms.author: v-yeche
ms.openlocfilehash: 5dda5215346f36e93d391ae9b409235c17e21896
ms.sourcegitcommit: ff67734e01c004be575782b4812cfe857e435f4d
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/08/2020
ms.locfileid: "84487003"
---
...
有关详细信息，请参阅全局对等互连的[要求和约束](/virtual-network/virtual-network-peering-overview#requirements-and-constraints)。
...
若要详细了解全球对等互连要求和约束，请参阅[虚拟网络对等互连](/virtual-network/virtual-network-peering-overview#requirements-and-constraints)。
...
1. 检查网络流量流：
    ...
    在源 VM 到目标 VM 之间进行[连接故障排除](/network-watcher/network-watcher-connectivity-overview)和 [IP 流验证](/network-watcher/network-watcher-ip-flow-verify-overview)，确定是否某个 NSG 或 UDR 导致流量流受到干扰。
...
* [服务链](/virtual-network/virtual-network-peering-overview#service-chaining)
...
有关详细信息，请参阅全球对等互连的[要求和约束](/virtual-network/virtual-network-peering-overview#requirements-and-constraints)，以及[不同的 VPN 拓扑](https://blogs.msdn.microsoft.com/igorpag/2016/02/11/hubspoke-daisy-chain-and-full-mesh-vnet-topologies-in-azure-arm-v2/)。
...
* [将应用与 Azure 虚拟网络集成](/app-service/web-sites-integrate-with-vnet)
