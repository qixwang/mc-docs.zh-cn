...
<!--Not Avaialble on Open an [Azure Cloud Shell](https://shell.azure.com)-->
...
<!--Not Available on Open a new tab for [Azure local Shell](https://shell.azure.com)-->
...
<!-- Update_Description: new article about tutorial create validate nat gateway portal -->
<!--NEW.date: 07/13/2020-->