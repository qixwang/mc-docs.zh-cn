...
<!--Mooncake Customization: Fit the portal of Azure China-->
...
<!--Not Available on If you haven't used Azure local Shell, [sign in now](https://shell.azure.com).-->
...
<!-- Update_Description: new article about quickstart create nat gateway portal -->
<!--NEW.date: 07/13/2020-->