...
ms.date: 01/13/2020
ms.author: v-yeche
ms.openlocfilehash: cb9e30f235f4f8402c09a6736ce2a6ce39dc7647
ms.sourcegitcommit: 9a75e933d5a76164bc4d903439d083c9ee7a23a0
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/08/2020
ms.locfileid: "75737377"
---
...
使用 [New-AzLoadBalancer](https://docs.microsoft.com/powershell/module/az.network/new-azloadbalancer) 创建基本负载均衡器。 以下示例使用前面步骤中创建的 IPv4 和 IPv6 前端 IP 配置、后端池和负载均衡规则创建名为 *myLoadBalancer* 的公共基本负载均衡器：
