...
本文档的余下内容假设使用的是[酒店评论示例](https://docs.azure.cn/search/knowledge-store-connect-power-bi)，但相同的概念也适用于从所有其他数据源扩充文档。
