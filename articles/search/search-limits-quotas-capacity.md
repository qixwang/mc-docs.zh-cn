...
ms.date: 04/20/2020
ms.openlocfilehash: f69c91696cc19cd41e0962dfaf15ae040834d147
ms.sourcegitcommit: 89ca2993f5978cd6dd67195db7c4bdd51a677371
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/30/2020
ms.locfileid: "82588690"
---
...
> 从 7 月 1 日起，所有层通常都可用，包括存储优化层。 所有定价都可以在[定价详细信息](https://www.azure.cn/pricing/details/search/)页上找到。
  ...
  S3 高密度 (S3 HD) 是针对这样的特定工作负载设计的：[多租户](search-modeling-multitenant-saas-applications.md)和大量的小索引（每个服务三千个索引）。 此层未提供[索引器功能](search-indexer-overview.md)。 在 S3 HD 上，数据引入必须利用推送方式，使用 API 调用将数据从源推送到索引。 
...
> [!NOTE]
> 虽然单个索引的最大容量通常受可用存储空间的限制，但可以存储在单个索引中的文档总数也有最大上限。 对于基本、S1、S2 和 S3 搜索服务，每个索引的这种限制约为 240 亿个文档；对于 S3HD 搜索服务，每个索引的限制约为 20 亿个文档。 在实施这些限制时，复杂集合的每个元素都算作单独的文档。
...
| -------- | ----------------- | ----------------- | --- | --- | --- | --- | --- | --- |
| 最大索引器数 |3 |5 或 15|50 |200 |200 |空值 |10 个 |10 个 |
| 最大数据源数 |3 |5 或 15 |50 |200 |200 |空值 |10 个 |10 个 |
| 最大技能集数<sup>4</sup> |3 |5 或 15 |50 |200 |200 |空值 |10 个 |10 个 |
