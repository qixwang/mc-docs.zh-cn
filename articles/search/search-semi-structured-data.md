...
1. 请将此调用的 URI 设置为 `https://[service name].search.azure.cn/indexes/clinical-trials-json-index/docs?search=*&api-version=2019-05-06&$count=true`。 请将 `[service name]` 替换为搜索服务的名称。
