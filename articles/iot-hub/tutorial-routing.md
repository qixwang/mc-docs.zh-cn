...
本教程使用 Azure CLI 创建基本资源，然后使用 [Azure 门户](https://portal.azure.cn)来演示如何配置消息路由和设置虚拟设备用于测试。
...
设置基本资源后，可以在 [Azure 门户](https://portal.azure.cn)中配置消息路由。
...
1. 在 [Azure 门户](https://portal.azure.cn)中选择“资源组”，然后选择你的资源组  。 本教程使用 ContosoResources  。
