...
ms.openlocfilehash: 5722b9c4891edbc176e1cf99dc1e6783e6162f7f
ms.sourcegitcommit: d32699135151e98471daebe6d3f5b650f64f826e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 07/24/2020
ms.locfileid: "87160380"
---
...
1. 使用应用程序 ID 和客户端密码从[客户端应用](#client-app-initialization)中的 `https://api.timeseries.azure.cn/` 获取令牌。 然后可使用该令牌调用时序见解 API。
...
* 使用 ADAL 进行身份验证：
   ...
   1. 随后可在应用程序调用时序见解 API 时，将令牌传入 `Authorization` 标头。
    ...
    请参阅我们的[使用 C# 管理 Azure 时序见解环境的 GA 参考数据](time-series-insights-manage-reference-data-csharp.md)一文了解详细信息。
