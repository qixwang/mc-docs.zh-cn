...
> * 有关迁移到新的 Azure 应用注册体验的全面信息，请阅读 [Azure 应用注册培训指南](/active-directory/develop/app-registrations-training-guide)和 [Azure Active Directory 快速入门](/active-directory/develop/quickstart-register-app)。
