...
> 此内容适用于较旧的 Azure AD v1.0 终结点。 建议对新项目使用 v2.0 终结点。 有关详细信息，请阅读[为什么更新到 Microsoft 标识平台 (v2.0)？](/active-directory/azuread-dev/azure-ad-endpoint-comparison) 以及 [Microsoft 标识平台限制](/active-directory/azuread-dev/azure-ad-endpoint-comparison#limitations)。
