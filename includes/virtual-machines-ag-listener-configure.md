...
1. <a name="getnet"></a>获取群集网络资源的名称。
    ...
    ![群集网络名称](./media/virtual-machines-ag-listener-configure/90-clusternetworkname.png) <a name="addcap"></a>
1. 添加客户端接入点。  
...
1. 使 SQL Server 可用性组资源依赖于客户端接入点。
...
1. 记下 IP 地址的**名称**。 该项可能为 `Cluster IP Address`。 
    ...
    <a name="setwsfcparam"></a>
1. 在 PowerShell 中设置群集参数。
