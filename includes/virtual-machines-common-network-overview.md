...
ms.openlocfilehash: 55cf08a5fe31937dcc9784c2443724f6c36456e6
ms.sourcegitcommit: c1ba5a62f30ac0a3acb337fb77431de6493e6096
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/17/2020
ms.locfileid: "80117065"
---
...
| [Azure CLI](../articles/virtual-machines/linux/multiple-nics.md) | 若要提供事先创建的公共 IP 地址标识符，请结合 [--public-ip-address](https://docs.azure.cn/cli/network/nic?view=azure-cli-latest#az-network-nic-create) 参数使用 **az network nic create**。 |
...
| 方法 | 说明 |
| ------ | ----------- |
| Azure 门户 | 可以[在 Azure 门户中通过基本负载均衡器对内部流量负载进行均衡](../articles/load-balancer/tutorial-load-balancer-basic-internal-portal.md)。 |
