...
> [!NOTE]
> 仅资源管理器部署模型支持 VpnGw SKU（VpnGw1、VpnGw2、VpnGw3、VpnGw4、VpnGw5）。 经典虚拟网络应继续使用老版（旧版）SKU。
...
(*) 可以对“PolicyBasedTrafficSelectors”进行配置，以便将基于路由的 VPN 网关连接到多个本地基于策略的防火墙设备。 有关详细信息，请参阅[使用 PowerShell 将 VPN 网关连接到多个本地基于策略的 VPN 设备](../articles/vpn-gateway/vpn-gateway-connect-multiple-policybased-rm-ps.md)。
