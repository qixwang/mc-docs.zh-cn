...
- 若要实现最低的延迟，请将邻近放置组与加速网络一起使用。 有关详细信息，请参阅[创建具有加速网络的 Linux 虚拟机](/virtual-network/create-vm-accelerated-networking-cli?toc=%2fvirtual-machines%2flinux%2ftoc.json)或[创建具有加速网络的 Windows 虚拟机](/virtual-network/create-vm-accelerated-networking-powershell?toc=%2fvirtual-machines%2fwindows%2ftoc.json)。
