...
<!--Not Avaiable on [Deploy Chef Automate from the Azure Marketplace](https://market.azure.cn/marketplace/apps/chef-software.chef-automate?tab=Overview)-->
...
- [创建基本的 DSC 配置](https://docs.microsoft.com/powershell/scripting/dsc/quickstarts/website-quickstart)。
...
<!--Not Available on [Create a development infrastructure on a Linux VM in Azure with Jenkins, GitHub, and Docker](../articles/jenkins/tutorial-jenkins-github-docker-cicd.md)-->
...
<!--Not Available on - [Deploy Spot VMs using a Resource Manager template](../articles/virtual-machines/linux/spot-template.md)-->
...
- [下载 VM 模板](../articles/virtual-machines/windows/download-template.md)。
    ...
    <!--Not Available on - [Create an Azure Image Builder template](../articles/virtual-machines/linux/image-builder-json.md)-->
