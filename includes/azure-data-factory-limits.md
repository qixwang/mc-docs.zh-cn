...
ms.openlocfilehash: a844eca1d378d68a8a14ba0f558b531459ebcecd
ms.sourcegitcommit: 95efd248f5ee3701f671dbd5cfe0aec9c9959a24
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 04/29/2020
ms.locfileid: "82515990"
---
...
| 资源 | 默认限制 | 最大限制 |
| -------- | ------------- | ------------- |
| Azure 订阅中的数据工厂 | 800 | 请[联系支持人员](https://support.azure.cn/zh-cn/support/support-azure/)。 |
...
| 每个 [Azure Integration Runtime 区域](../articles/data-factory/concepts-integration-runtime.md#integration-runtime-location)的每个订阅的并发外部活动运行数<br><small>外部活动在集成运行时上托管，但在链接服务（包括存储过程、HDInsights、Web 等）上执行。</small> | 3000 | 请[联系支持人员](https://support.azure.cn/zh-cn/support/support-azure/)。 |
