...
| 数据保留 | [30 - 730 天](/azure-monitor/app/pricing)  | 此资源适用于[搜索](../articles/azure-monitor/app/diagnostic-search.md)、[分析](/azure-monitor/log-query/log-query-overview)和[指标资源管理器](../articles/azure-monitor/platform/metrics-charts.md)。
