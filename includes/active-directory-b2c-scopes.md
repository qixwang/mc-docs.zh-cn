...
ms.date: 06/28/2020
ms.author: v-junlch
ms.openlocfilehash: a2a68d96c261985f6285466bf8457a627c536eba
ms.sourcegitcommit: 3a8a7d65d0791cdb6695fe6c2222a1971a19f745
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/28/2020
ms.locfileid: "85516461"
---
...
1. 将默认值（一个 GUID）替换为 `api`，然后选择“保存”。 完整的 URI 已显示，应采用 `https://your-tenant-name.partner.onmschina.cn/api` 格式。 Web 应用程序在请求 API 的访问令牌时，应将此 URI 添加为你为 API 定义的每个范围的前缀。
