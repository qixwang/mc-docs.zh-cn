...
注册标识提供者后，请结合提供者的名称调用 `.login()` 方法。 例如，若要使用 MicrosoftAccount 登录，请使用以下代码：
...
### <a name="how-to-obtain-information-about-the-authenticated-user"></a><a name="auth-getinfo"></a>如何：获取已经过身份验证的用户相关信息
